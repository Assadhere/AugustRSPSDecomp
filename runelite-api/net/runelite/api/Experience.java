...
public class Experience {
   ...
   public static int getNextCombatLevelMelee(int attackLevel, int strengthLevel, int defenceLevel, int hitpointsLevel, int magicLevel, int rangeLevel, int prayerLevel) {
      int nextCombatLevel = getCombatLevel(attackLevel, strengthLevel, defenceLevel, hitpointsLevel, magicLevel, rangeLevel, prayerLevel) + 1;
      return (int)Math.ceil(-0.7692307692307693 * ((double)(defenceLevel + hitpointsLevel) + Math.floor((double)(prayerLevel / 2)) - (double)(4 * nextCombatLevel))) - strengthLevel - attackLevel;
   }
   ...
   public static int getNextCombatLevelHpDef(int attackLevel, int strengthLevel, int defenceLevel, int hitpointsLevel, int magicLevel, int rangeLevel, int prayerLevel) {
      int nextCombatLevel = getCombatLevel(attackLevel, strengthLevel, defenceLevel, hitpointsLevel, magicLevel, rangeLevel, prayerLevel) + 1;
      double typeContribution = getMeleeRangeOrMagicCombatLevelContribution(attackLevel, strengthLevel, magicLevel, rangeLevel);
      return (int)Math.ceil((double)(4 * nextCombatLevel) - Math.floor((double)(prayerLevel / 2)) - 4.0 * typeContribution) - hitpointsLevel - defenceLevel;
   }
   ...
   public static int getNextCombatLevelMagic(int attackLevel, int strengthLevel, int defenceLevel, int hitpointsLevel, int magicLevel, int rangeLevel, int prayerLevel) {
      int nextCombatLevel = getCombatLevel(attackLevel, strengthLevel, defenceLevel, hitpointsLevel, magicLevel, rangeLevel, prayerLevel) + 1;
      return (int)Math.ceil(0.6666666666666666 * Math.ceil(-0.7692307692307693 * ((double)(hitpointsLevel + defenceLevel - 4 * nextCombatLevel) + Math.floor((double)(prayerLevel / 2))))) - magicLevel;
   }
   ...
   public static int getNextCombatLevelRange(int attackLevel, int strengthLevel, int defenceLevel, int hitpointsLevel, int magicLevel, int rangeLevel, int prayerLevel) {
      int nextCombatLevel = getCombatLevel(attackLevel, strengthLevel, defenceLevel, hitpointsLevel, magicLevel, rangeLevel, prayerLevel) + 1;
      return (int)Math.ceil(0.6666666666666666 * Math.ceil(-0.7692307692307693 * ((double)(hitpointsLevel + defenceLevel - 4 * nextCombatLevel) + Math.floor((double)(prayerLevel / 2))))) - rangeLevel;
   }
