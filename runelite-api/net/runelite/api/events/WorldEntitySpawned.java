...
public final class WorldEntitySpawned {
   private final WorldEntity worldEntity;

   public WorldEntitySpawned(WorldEntity worldEntity) {
   ...
   public boolean equals(Object o) {
      if (o == this) {
         return true;
      } else if (!(o instanceof WorldEntitySpawned)) {
         return false;
      } else {
         WorldEntitySpawned other = (WorldEntitySpawned)o;
   ...
   public String toString() {
      return "WorldEntitySpawned(worldEntity=" + String.valueOf(this.getWorldEntity()) + ")";
   }
}
