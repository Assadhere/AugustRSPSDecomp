...
public class AreaSoundEffectPlayed {
   ...
   public boolean equals(Object o) {
      if (o == this) {
         return true;
      } else if (!(o instanceof AreaSoundEffectPlayed)) {
         return false;
      } else {
         AreaSoundEffectPlayed other = (AreaSoundEffectPlayed)o;
         if (!other.canEqual(this)) {
            return false;
         } else if (this.getSoundId() != other.getSoundId()) {
            return false;
         } else if (this.getSceneX() != other.getSceneX()) {
            return false;
         } else if (this.getSceneY() != other.getSceneY()) {
            return false;
         } else if (this.getRange() != other.getRange()) {
            return false;
         } else if (this.getDelay() != other.getDelay()) {
            return false;
         } else if (this.isConsumed() != other.isConsumed()) {
            return false;
         } else {
   ...
   public String toString() {
      ...
      return "AreaSoundEffectPlayed(source=" + var10000 + ", soundId=" + this.getSoundId() + ", sceneX=" + this.getSceneX() + ", sceneY=" + this.getSceneY() + ", range=" + this.getRange() + ", delay=" + this.getDelay() + ", consumed=" + this.isConsumed() + ")";
   }
}
