...
public final class SpriteID {
   ...
   public static final class HeadbarBlood30 {
      ...
      public static final int FRONT = 5863;
      public static final int BACK = 5864;
   }
   ...
   public static final class IconActivities25x25 {
      ...
      public static final int CLUE_SCROLL_ALL = 5853;
      public static final int BOUNTY_HUNTER_HUNTER = 5854;
      public static final int BOUNTY_HUNTER_ROGUE = 5855;
      public static final int LAST_MAN_STANDING = 5856;
      public static final int LEAGUE_POINTS = 5857;
      public static final int SOUL_WARS_ZEAL = 5858;
      public static final int PVP_ARENA_RANK = 5859;
      public static final int RIFTS_CLOSED = 5860;
      public static final int DEADMAN_POINTS = 5861;
      public static final int COLOSSEUM_GLORY = 5862;
      public static final int COLLECTIONS_LOGGED = 6390;
   }
   ...
   public static final class Prayerglow {
      ...
      public static final int ACTIVATED = 4892;
   }
   ...
   public static final class IconPrayerZaros01_30x30 {
      ...
      public static final int ANCIENT_STRENGTH = 4843;
      public static final int ANCIENT_SIGHT = 4844;
      public static final int ANCIENT_WILL = 4845;
      public static final int TRINITAS = 4850;
      public static final int DECIMATE = 4854;
      public static final int ANNIHILATE = 4855;
      public static final int VAPORISE = 4856;
      public static final int DAMPEN_MELEE = 4849;
      public static final int DAMPEN_RANGED = 4848;
      public static final int DAMPEN_MAGIC = 4847;
      public static final int PURGE = 4852;
      public static final int REJUVENATION = 4842;
      public static final int RUINOUS_GRACE = 4846;
      public static final int WRATH = 4862;
      public static final int METABOLISE = 4853;
      public static final int BERSERKER = 4851;
      public static final int FUMUS_VOW = 4858;
      public static final int CRUORS_VOW = 4860;
      public static final int UMBRAS_VOW = 4859;
      public static final int GLACIES_VOW = 4861;
      public static final int INTENSIFY = 4864;
      public static final int REBUKE = 4857;
      public static final int VINDICATION = 4863;
      public static final int PROTECT_ITEM = 4865;
   }
   ...
   public static final class IconBoss25x25 {
      ...
      public static final int MIMIC = 4260;
      public static final int OBOR = 4261;
      public static final int BRYOPHYTA = 4262;
      public static final int GIANT_MOLE = 4263;
      public static final int GROTESQUE_GUARDIANS = 4264;
      public static final int TEMPOROSS = 4265;
      public static final int WINTERTODT = 4266;
      public static final int BARROWS_CHESTS = 4267;
      public static final int SARACHNIS = 4269;
      public static final int KALPHITE_QUEEN = 4270;
      public static final int HESPORI = 4271;
      public static final int SKOTIZO = 4272;
      public static final int ZALCANO = 4273;
      public static final int KING_BLACK_DRAGON = 4274;
      public static final int KRAKEN = 4275;
      public static final int ABYSSAL_SIRE = 4276;
      public static final int THERMONUCLEAR_SMOKE_DEVIL = 4277;
      public static final int THE_GAUNTLET = 4278;
      public static final int ZULRAH = 4279;
      public static final int CERBERUS = 4280;
      public static final int VORKATH = 4281;
      public static final int GENERAL_GRAARDOR = 4282;
      public static final int KRIL_TSUTSAROTH = 4283;
      public static final int COMMANDER_ZILYANA = 4284;
      public static final int KREEARRA = 4285;
      public static final int NIGHTMARE = 4286;
      public static final int CORPOREAL_BEAST = 4287;
      public static final int CHAMBERS_OF_XERIC = 4288;
      public static final int ALCHEMICAL_HYDRA = 4289;
      public static final int THEATRE_OF_BLOOD = 4290;
      public static final int NEX = 4291;
      public static final int DAGANNOTH_SUPREME = 4292;
      public static final int DAGANNOTH_REX = 4293;
      public static final int DAGANNOTH_PRIME = 4294;
      public static final int THE_CORRUPTED_GAUNTLET = 4295;
      public static final int CHAMBERS_OF_XERIC_CHALLENGE_MODE = 4296;
      public static final int TOMBS_OF_AMASCUT = 4297;
      public static final int TOMBS_OF_AMASCUT_EXPERT = 4298;
      public static final int PHANTOM_MUSPAH = 4299;
      public static final int CHAOS_ELEMENTAL = 5621;
      public static final int ARTIO_CALLISTO = 5622;
      public static final int CALVARION_VETION = 5623;
      public static final int SPINDEL_VENENATIS = 5624;
      public static final int CHAOS_FANATIC = 5625;
      public static final int CRAZY_ARCHAEOLOGIST = 5626;
      public static final int DERANGED_ARCHAEOLOGIST = 5627;
      public static final int SCORPIA = 5628;
      public static final int TZTOK_JAD = 5629;
      public static final int TZKAL_ZUK = 5630;
      public static final int THE_WHISPERER = 5631;
      public static final int DUKE_SUCELLUS = 5632;
      public static final int THE_LEVIATHAN = 5633;
      public static final int VARDORVIS = 5634;
      public static final int SCURRIUS = 5635;
      public static final int SOL_HEREDIT = 5636;
      public static final int LUNAR_CHESTS = 5637;
      public static final int ARAXXOR = 5638;
      public static final int AMOXLIATL = 5639;
      public static final int THE_HUEYCOATL = 5640;
      public static final int ROYAL_TITANS = 6345;
      public static final int YAMA = 6346;
      public static final int DOOM_OF_MOKHAIOTL = 6347;
      public static final int SHELLBANE_GRYPHON = 6349;
      public static final int BRUTUS = 6352;
   }
   ...
   public static final class ReportButton {
      ...
      public static final int BUTTON = 3057;
      public static final int HOVERED = 3058;
   }
   ...
   public static final class ChatTabButton {
      ...
      public static final int BUTTON = 3051;
      public static final int HOVERED = 3052;
      public static final int NEW_MESSAGES = 3055;
      public static final int SELECTED = 3053;
      public static final int SELECTED_HOVERED = 3054;
   }
   ...
   public static final class HeadbarShootingStar50 {
      ...
      public static final int FRONT = 2967;
      public static final int BACK = 2968;
   }
   ...
   public static final class SettingsSlider {
      ...
      public static final int HANDLE_BLUE = 2858;
      public static final int HANDLE_RED = 2859;
      public static final int HANDLE_GREEN = 2860;
   }
   ...
   public static final class ChatchannelRankIcons {
      ...
      public static final int SMILEY_FRIEND = 2825;
      public static final int CROWN_JAGEX_MODERATOR = 2826;
      public static final int KEY_CHANNEL_OWNER = 2827;
      public static final int GOLD_STAR_GENERAL = 2828;
      public static final int SILVER_STAR_CAPTAIN = 2829;
      public static final int BRONZE_STAR_LIEUTENANT = 2830;
      public static final int TRIPLE_CHEVRON_SERGEANT = 2831;
      public static final int DOUBLE_CHEVRON_CORPORAL = 2832;
      public static final int SINGLE_CHEVRON_RECRUIT = 2833;
   }
   ...
   public static final class StandardHealth50 {
      ...
      public static final int FRONT = 2178;
      public static final int BACK = 2179;
   }

   public static final class StandardHealth30 {
      public static final int _0 = 2176;
      public static final int _1 = 2177;
      public static final int FRONT = 2176;
      public static final int BACK = 2177;
   }
   ...
   public static final class OsmFnModeIcons {
      ...
      public static final int ENABLED = 1623;
      public static final int DISABLED = 1624;
   }
   ...
   public static final class Spectator {
      ...
      public static final int HITPOINTS = 1604;
      public static final int PRAYER = 1605;
      public static final int SPECIAL = 1606;
   }
   ...
   public static final class Thumbs {
      ...
      public static final int UP = 1600;
      public static final int DOWN = 1601;
      public static final int UP_HOVERED = 1602;
      public static final int DOWN_HOVERED = 1603;
   }
   ...
   public static final class PohDoors {
      ...
      public static final int CLOSED = 1576;
      public static final int OPEN = 1577;
      public static final int INVISIBLE = 1578;
   }

   public static final class Arrow {
      public static final int _0 = 1542;
      public static final int _1 = 1543;
      public static final int BROWN_UP = 1542;
      public static final int YELLOW_UP = 1543;
   }
   ...
   public static final class WorldmapMarker {
      ...
      public static final int YOU_ARE_HERE = 1539;
      public static final int OFFSCREEN_FOCUS_ARROW = 1540;
      public static final int OFFSCREEN_FOCUS_ARROW_DIAGONAL = 1541;
   }
   ...
   public static final class Mapfunction {
      ...
      public static final int GENERAL_STORE = 1448;
      public static final int SWORD_SHOP = 1449;
      public static final int MAGIC_SHOP = 1450;
      public static final int AXE_SHOP = 1451;
      public static final int HELMET_SHOP = 1452;
      public static final int BANK = 1453;
      public static final int QUEST_START = 1454;
      public static final int AMULET_SHOP = 1455;
      public static final int MINING_SITE = 1456;
      public static final int FURNACE = 1457;
      public static final int ANVIL = 1458;
      public static final int COMBAT_TRAINING = 1459;
      public static final int DUNGEON = 1460;
      public static final int STAFF_SHOP = 1461;
      public static final int PLATEBODY_SHOP = 1462;
      public static final int PLATELEGS_SHOP = 1463;
      public static final int SCIMITAR_SHOP = 1464;
      public static final int ARCHERY_SHOP = 1465;
      public static final int SHIELD_SHOP = 1466;
      public static final int ALTAR = 1467;
      public static final int HERBALIST = 1468;
      public static final int JEWELLERY_SHOP = 1469;
      public static final int GEM_SHOP = 1470;
      public static final int CRAFTING_SHOP = 1471;
      public static final int CANDLE_SHOP = 1472;
      public static final int FISHING_SHOP = 1473;
      public static final int FISHING_SPOT = 1474;
      public static final int CLOTHES_SHOP = 1475;
      public static final int APOTHECARY = 1476;
      public static final int SILK_TRADER = 1477;
      public static final int FOOD_SHOP_KEBAB = 1478;
      public static final int PUB = 1479;
      public static final int MACE_SHOP = 1480;
      public static final int TANNERY = 1481;
      public static final int RARE_TREES = 1482;
      public static final int SPINNING_WHEEL = 1483;
      public static final int FOOD_SHOP = 1484;
      public static final int FOOD_SHOP_CUTLERY = 1485;
      public static final int MINIGAME = 1486;
      public static final int WATER_SOURCE = 1487;
      public static final int COOKING_RANGE = 1488;
      public static final int PLATESKIRT_SHOP = 1489;
      public static final int POTTERY_WHEEL = 1490;
      public static final int WINDMILL = 1491;
      public static final int MINING_SHOP = 1492;
      public static final int CHAINMAIL_SHOP = 1493;
      public static final int SILVER_SHOP = 1494;
      public static final int FUR_TRADER = 1495;
      public static final int SPICE_SHOP = 1496;
      public static final int AGILITY_TRAINING = 1497;
      public static final int FOOD_SHOP_FRUIT = 1498;
      public static final int SLAYER_MASTER = 1499;
      public static final int HAIRDRESSER = 1500;
      public static final int FARMING_PATCH = 1501;
      public static final int MAKEOVER_MAGE = 1502;
      public static final int GUIDE = 1503;
      public static final int TRANSPORTATION = 1504;
      public static final int HOUSE_PORTAL = 1505;
      public static final int FARMING_SHOP = 1506;
      public static final int LOOM = 1507;
      public static final int BREWERY = 1508;
      public static final int DAIRY_CHURN = 1509;
      public static final int STAGNANT_WATER_SOURCE = 1510;
      public static final int HUNTER_TRAINING = 1511;
      public static final int POLL_BOOTH = 1512;
      public static final int HUNTER_SHOP = 1513;
      public static final int INFORMATION_I_1514 = 1514;
      public static final int ESTATE_AGENT = 1515;
      public static final int SAWMILL = 1516;
      public static final int STONEMASON = 1517;
      public static final int AGILITY_SHORT_CUT = 1518;
      public static final int WOODCUTTING_STUMP = 1519;
      public static final int HOLIDAY_EVENT = 1520;
      public static final int SANDPIT = 1521;
      public static final int TASK_MASTER = 1522;
      public static final int PET_SHOP = 1523;
      public static final int BOUNTY_HUNTER_TRADER = 1524;
      public static final int IRON_MAN_TUTORS = 1525;
      public static final int PRICING_EXPERT_WEAPONS_AND_ARMOUR = 1526;
      public static final int PRICING_EXPERT_LOGS = 1527;
      public static final int PRICING_EXPERT_HERBS = 1528;
      public static final int PRICING_EXPERT_RUNES = 1529;
      public static final int PRICING_EXPERT_ORES_AND_BARS = 1530;
      public static final int GRAND_EXCHANGE = 1531;
      public static final int KOUREND_TASK = 1532;
      public static final int RAIDS_LOBBY = 1533;
      public static final int MAP_LINK_DOWNSTAIRS = 1534;
      public static final int MAP_LINK_UPSTAIRS = 1535;
   }
   ...
   public static final class WorldmapIcon {
      ...
      public static final int PLANET = 1439;
      public static final int PLANET_HOVERED = 1440;
   }
   ...
   public static final class Clickcross {
      ...
      public static final int YELLOW_CLICK_ANIMATION_1 = 1430;
      public static final int YELLOW_CLICK_ANIMATION_2 = 1431;
      public static final int YELLOW_CLICK_ANIMATION_3 = 1432;
      public static final int YELLOW_CLICK_ANIMATION_4 = 1433;
      public static final int RED_CLICK_ANIMATION_1 = 1434;
      public static final int RED_CLICK_ANIMATION_2 = 1435;
      public static final int RED_CLICK_ANIMATION_3 = 1436;
      public static final int RED_CLICK_ANIMATION_4 = 1437;
   }

   public static final class Reset {
      public static final int _0 = 1428;
      public static final int _1 = 1429;
      public static final int BUTTON = 1428;
      public static final int HOVERED = 1429;
   }

   public static final class HeadbarOlmtimer100 {
      public static final int _0 = 1417;
      public static final int _1 = 1418;
      public static final int YELLOW = 1417;
      public static final int RED = 1418;
   }

   public static final class HeadbarShield100 {
      public static final int _0 = 1415;
      public static final int _1 = 1416;
      public static final int COX_GREEN = 1415;
      public static final int COX_BLUE = 1416;
   }
   ...
   public static final class TinyCombatStaticons {
      ...
      public static final int ATTACK = 1401;
      public static final int STRENGTH = 1402;
      public static final int DEFENCE = 1403;
      public static final int RANGED = 1404;
      public static final int PRAYER = 1405;
      public static final int MAGIC = 1406;
      public static final int HITPOINTS = 1407;
   }
   ...
   public static final class WintIcons {
      ...
      public static final int CRAFTING = 1397;
      public static final int FIREMAKING_LOGS = 1398;
      public static final int FIREMAKING = 1399;
      public static final int MAGIC_RED = 1400;
   }
   ...
   public static final class PohRoomLayouts {
      ...
      public static final int PARLOUR = 1368;
      public static final int GARDEN = 1369;
      public static final int KITCHEN = 1370;
      public static final int DINING_ROOM = 1371;
      public static final int BEDROOM = 1372;
      public static final int GAMES_ROOM = 1373;
      public static final int SKILL_HALL = 1374;
      public static final int QUEST_HALL = 1375;
      public static final int CHAPEL = 1376;
      public static final int WORKSHOP = 1377;
      public static final int STUDY = 1378;
      public static final int PORTAL_CHAMBER = 1379;
      public static final int THRONE_ROOM = 1380;
      public static final int OUBLIETTE = 1381;
      public static final int DUNGEON_CORRIDOR = 1382;
      public static final int DUNGEON_JUNCTION = 1383;
      public static final int DUNGEON_STAIRS_ROOM = 1384;
      public static final int TREASURE_ROOM = 1385;
      public static final int FORMAL_GARDEN = 1386;
      public static final int COMBAT_ROOM = 1387;
      public static final int COSTUME_ROOM = 1388;
      public static final int MENAGERIE_INDOORS = 1389;
      public static final int MENAGERIE_OUTDOORS = 1390;
      public static final int SUPERIOR_GARDEN = 1391;
      public static final int ACHIEVEMENT_GALLERY = 1392;
   }

   public static final class FastForward {
      public static final int _0 = 1364;
      public static final int _1 = 1365;
      public static final int BUTTON = 1364;
      public static final int HOVERED = 1365;
   }
   ...
   public static final class DeadmanDeathtype {
      ...
      public static final int DEATH_TO_PVM = 1346;
      public static final int DEATH_TO_PVP = 1347;
      public static final int DEATH_WHILE_SKULLED = 1348;
      public static final int DEATH_WHILE_SKULLED_IN_SAFE_ZONE = 1349;
   }
   ...
   public static final class FavouriteIcons {
      ...
      public static final int REMOVE = 1340;
      public static final int ADD = 1341;
   }
   ...
   public static final class MagicNecroOff {
      ...
      public static final int MARK_OF_DARKNESS_DISABLED = 1324;
      public static final int WARD_OF_ARCEUUS_DISABLED = 1325;
      public static final int GREATER_CORRUPTION_DISABLED = 1327;
      public static final int DEATH_CHARGE_DISABLED = 1329;
      public static final int SHADOW_VEIL_DISABLED = 1334;
      public static final int RESURRECT_SUPERIOR_SKELETON_DISABLED = 2987;
   }

   public static final class ZeahBook {
      public static final int _0 = 1240;
      public static final int _1 = 1241;
      public static final int BUTTON = 1240;
      public static final int HOVERED = 1241;
   }
   ...
   public static final class CombatboxesSplit {
      ...
      public static final int LEFT = 1229;
      public static final int MIDDLE = 1230;
      public static final int RIGHT = 1231;
      public static final int LEFT_SELECTED = 1232;
      public static final int MIDDLE_SELECTED = 1233;
      public static final int RIGHT_SELECTED = 1234;
   }
   ...
   public static final class Checkbox {
      ...
      public static final int EMPTY = 1215;
      public static final int CROSSED = 1216;
      public static final int CHECKED = 1217;
      public static final int HOVERED = 1218;
      public static final int CROSSED_HOVERED = 1219;
      public static final int CHECKED_HOVERED = 1220;
   }
   ...
   public static final class OrbXp {
      ...
      public static final int ORB = 1196;
      public static final int ACTIVATED = 1197;
      public static final int HOVERED = 1198;
      public static final int ACTIVATED_HOVERED = 1199;
   }
   ...
   public static final class WindowmodeIcons {
      ...
      public static final int FIXED_MODE_DISABLED_VERTICAL = 1171;
      public static final int RESIZEABLE_MODE_DISABLED_VERTICAL = 1172;
      public static final int FIXED_MODE_ENABLED = 1572;
      public static final int RESIZEABLE_MODE_ENABLED = 1573;
      public static final int FIXED_MODE_ENABLED_VERTICAL = 1574;
      public static final int RESIZEABLE_MODE_ENABLED_VERTICAL = 1575;
   }
   ...
   public static final class WorldswitcherFlags {
      ...
      public static final int NONE = 1132;
      public static final int USA = 1133;
      public static final int CANADA = 1134;
      public static final int UK = 1135;
      public static final int NETHERLANDS = 1136;
      public static final int AUSTRALIA = 1137;
      public static final int SWEDEN = 1138;
      public static final int FINLAND = 1139;
      public static final int GERMANY = 1140;
      public static final int US_WEST = 4936;
      public static final int US_EAST = 4937;
   }
   ...
   public static final class WorldswitcherStars {
      ...
      public static final int FREE = 1130;
      public static final int MEMBERS = 1131;
      public static final int PVP = 1237;
      public static final int DEADMAN = 1238;
      public static final int BLUE = 1338;
   }
   ...
   public static final class GeCancel {
      ...
      public static final int BUTTON = 1126;
      public static final int HOVERED = 1127;
   }
   ...
   public static final class GeTextbackdrop {
      ...
      public static final int LEFT = 1123;
      public static final int MIDDLE = 1124;
      public static final int RIGHT = 1125;
   }
   ...
   public static final class GeSmallicons {
      ...
      public static final int GUIDE_PRICE = 1112;
      public static final int SEARCH = 1113;
      public static final int FAST_DECREMENT_ARROW = 1114;
      public static final int FAST_INCREMENT_ARROW = 1115;
      public static final int DECREMENT_BUTTON = 1116;
      public static final int INCREMENT_BUTTON = 1117;
      public static final int COLLECTION_BOX_OFFER_BUY = 1118;
      public static final int COLLECTION_BOX_OFFER_SELL = 1119;
   }
   ...
   public static final class GeIcons {
      ...
      public static final int MAKE_OFFER_SELL = 1106;
      public static final int MAKE_OFFER_SELL_HOVERED = 1107;
      public static final int MAKE_OFFER_BUY = 1108;
      public static final int MAKE_OFFER_BUY_HOVERED = 1109;
      public static final int BUTTON = 1110;
      public static final int BUTTON_HOVERED = 1111;
   }
   ...
   public static final class BanktabIcons {
      ...
      public static final int ALL_ITEMS = 1081;
      public static final int ADD = 1082;
      public static final int WRENCH = 1083;
      public static final int EQUIPMENT = 2417;
   }
   ...
   public static final class Banktabs {
      ...
      public static final int TAB = 1077;
      public static final int HOVERED = 1078;
      public static final int SELECTED = 1079;
      public static final int EMPTY = 1080;
   }
   ...
   public static final class OrbFrame {
      ...
      public static final int FRAME = 1071;
      public static final int FRAME_HOVERED = 1072;
   }
   ...
   public static final class OrbFiller {
      ...
      public static final int EMPTY = 1059;
      public static final int HITPOINTS = 1060;
      public static final int HITPOINTS_POISON = 1061;
      public static final int HITPOINTS_DISEASE = 1062;
      public static final int PRAYER = 1063;
      public static final int RUN = 1064;
      public static final int RUN_ACTIVATED = 1065;
      public static final int PRAYER_ACTIVATED = 1066;
      public static final int HITPOINTS_VENOM = 1102;
      public static final int SPECIAL = 1607;
      public static final int SPECIAL_ACTIVATED = 1608;
   }
   ...
   public static final class OrbIcon {
      ...
      public static final int PRAYER_ICON_ACTIVATED = 1058;
      public static final int HITPOINTS = 1067;
      public static final int PRAYER = 1068;
      public static final int WALK = 1069;
      public static final int RUN = 1070;
      public static final int RUN_ICON_SLOWED_DEPLETION = 1092;
      public static final int SPECIAL = 1610;
   }

   public static final class Sortarrows {
      public static final int _0 = 1050;
      public static final int _1 = 1051;
      public static final int ASCENDING = 1050;
      public static final int DESCENDING = 1051;
   }
   ...
   public static final class Bankbuttons {
      ...
      public static final int DEPOSIT_EQUIPMENT = 1042;
      public static final int SEARCH = 1043;
      public static final int DEPOSIT_LOOTING_BAG = 1074;
      public static final int RAID_SEND_TO_INVENTORY = 1226;
      public static final int RAID_SEND_TO_BANK = 1227;
      public static final int RAID_SEND_TO_TRASH = 1235;
      public static final int PLACEHOLDERS_LOCK = 1342;
   }
   ...
   public static final class SideStoneHighlights {
      ...
      public static final int TOP_LEFT = 1026;
      public static final int TOP_RIGHT = 1027;
      public static final int BOTTOM_LEFT = 1028;
      public static final int BOTTOM_RIGHT = 1029;
      public static final int MIDDLE = 1030;
   }
   ...
   public static final class MagicNecroOn {
      ...
      public static final int BASIC_REANIMATION = 1247;
      public static final int ADEPT_REANIMATION = 1248;
      public static final int EXPERT_REANIMATION = 1249;
      public static final int MASTER_REANIMATION = 1250;
      public static final int ARCEUUS_LIBRARY_TELEPORT = 1252;
      public static final int DRAYNOR_MANOR_TELEPORT = 1253;
      public static final int SALVE_GRAVEYARD_TELEPORT = 1254;
      public static final int MIND_ALTAR_TELEPORT = 1256;
      public static final int RESPAWN_TELEPORT = 1257;
      public static final int FENKENSTRAINS_CASTLE_TELEPORT = 1259;
      public static final int WEST_ARDOUGNE_TELEPORT = 1260;
      public static final int HARMONY_ISLAND_TELEPORT = 1261;
      public static final int BARROWS_TELEPORT = 1262;
      public static final int APE_ATOLL_TELEPORT = 1263;
      public static final int CEMETERY_TELEPORT = 1264;
      public static final int RESURRECT_CROPS = 1266;
      public static final int GHOSTLY_GRASP = 1267;
      public static final int SKELETAL_GRASP = 1268;
      public static final int UNDEAD_GRASP = 1269;
      public static final int RESURRECT_LESSER_GHOST = 1270;
      public static final int INFERIOR_DEMONBANE = 1302;
      public static final int SUPERIOR_DEMONBANE = 1303;
      public static final int DARK_DEMONBANE = 1304;
      public static final int MARK_OF_DARKNESS = 1305;
      public static final int WARD_OF_ARCEUUS = 1306;
      public static final int LESSER_CORRUPTION = 1307;
      public static final int GREATER_CORRUPTION = 1308;
      public static final int DEATH_CHARGE = 1310;
      public static final int DEMONIC_OFFERING = 1311;
      public static final int SINISTER_OFFERING = 1312;
      public static final int SHADOW_VEIL = 1315;
      public static final int DARK_LURE = 1316;
      public static final int VILE_VIGOUR = 1317;
      public static final int DEGRIME = 1318;
      public static final int RESURRECT_SUPERIOR_SKELETON = 2981;
      public static final int RESURRECT_GREATER_ZOMBIE = 2984;
   }
   ...
   public static final class PvpwIcons {
      ...
      public static final int PLAYER_KILLER_SKULL = 1046;
   ...
   public static final class TabsLarge {
      ...
      public static final int TAB = 1015;
      public static final int HOVERED = 1016;
   }
   ...
   public static final class TabsSplit {
      ...
      public static final int EDGE_LEFT = 998;
      public static final int MIDDLE = 999;
      public static final int EDGE_RIGHT = 1000;
      public static final int EDGE_LEFT_HOVERED = 1001;
      public static final int MIDDLE_HOVERED = 1002;
      public static final int EDGE_RIGHT_HOVERED = 1003;
   }
   ...
   public static final class V2BordersSlim {
      ...
      public static final int HORIZONTAL_A = 987;
      public static final int VERTICAL_A = 988;
      public static final int HORIZONTAL_B = 989;
      public static final int VERTICAL_B = 990;
      public static final int TOP_LEFT = 991;
      public static final int TOP_RIGHT = 992;
      public static final int BOTTOM_LEFT = 993;
      public static final int BOTTOM_RIGHT = 994;
      public static final int HORIZONTAL_C = 995;
      public static final int INTERSECTION_LEFT = 996;
      public static final int INTERSECTION_RIGHT = 997;
   }
   ...
   public static final class Tabs {
      ...
      public static final int SLANTED_TAB = 952;
      public static final int SLANTED_TAB_HOVERED = 953;
   }
   ...
   public static final class WarningIcons {
      ...
      public static final int DISABLED = 940;
      public static final int ROUND_CHECK_BUTTON = 941;
      public static final int ROUND_CHECK_BUTTON_CHECKED = 942;
   }

   public static final class AmeConfirmButtonNoBack {
      public static final int _0 = 938;
      public static final int _1 = 939;
      public static final int THUMB_UP = 938;
      public static final int THUMB_UP_HOVERED = 939;
   }
   ...
   public static final class V2StoneButtonOut {
      ...
      public static final int A_TOP_LEFT = 929;
      public static final int A_TOP_RIGHT = 930;
      public static final int A_BOTTOM_LEFT = 931;
      public static final int A_BOTTOM_RIGHT = 932;
      public static final int A_MAP_EDGE_LEFT = 933;
      public static final int A_MAP_EDGE_TOP = 934;
      public static final int A_MAP_EDGE_RIGHT = 935;
      public static final int A_MAP_EDGE_BOTTOM = 936;
      public static final int B_TOP_LEFT = 1554;
      public static final int B_TOP_RIGHT = 1555;
      public static final int B_BOTTOM_LEFT = 1556;
      public static final int B_BOTTOM_RIGHT = 1557;
      public static final int B_LEFT = 1558;
      public static final int B_TOP = 1559;
      public static final int B_RIGHT = 1560;
      public static final int B_BOTTOM = 1561;
   }
   ...
   public static final class V2StoneButtonIn {
      ...
      public static final int A_TOP_LEFT = 921;
      public static final int A_TOP_RIGHT = 922;
      public static final int A_BOTTOM_LEFT = 923;
      public static final int A_BOTTOM_RIGHT = 924;
      public static final int A_LEFT = 925;
      public static final int A_TOP = 926;
      public static final int A_RIGHT = 927;
      public static final int A_BOTTOM = 928;
      public static final int B_TOP_LEFT = 1546;
      public static final int B_TOP_RIGHT = 1547;
      public static final int B_BOTTOM_LEFT = 1548;
      public static final int B_BOTTOM_RIGHT = 1549;
      public static final int B_LEFT = 1550;
      public static final int B_TOP = 1551;
      public static final int B_RIGHT = 1552;
      public static final int B_BOTTOM = 1553;
   }
   ...
   public static final class V2StoneButton {
      ...
      public static final int TOP_LEFT = 913;
      public static final int TOP_RIGHT = 914;
      public static final int BOTTOM_LEFT = 915;
      public static final int BOTTOM_RIGHT = 916;
      public static final int LEFT = 917;
      public static final int TOP = 918;
      public static final int RIGHT = 919;
      public static final int BOTTOM = 920;
   }
   ...
   public static final class SideiconsNew {
      ...
      public static final int COMBAT = 881;
      public static final int STATS = 882;
      public static final int QUESTS = 883;
      public static final int EQUIPMENT = 885;
      public static final int PRAYER = 886;
      public static final int MAGIC = 887;
      public static final int FRIENDS = 888;
      public static final int IGNORES = 889;
      public static final int LOGOUT = 890;
      public static final int OPTIONS = 891;
      public static final int EMOTES = 892;
      public static final int MUSIC = 893;
      public static final int HOUSE = 894;
      public static final int SUMMONING = 896;
   }

   public static final class AmeConfirmButton {
      public static final int _0 = 879;
      public static final int _1 = 880;
      public static final int BUTTON = 879;
      public static final int HOVERED = 880;
   }
   ...
   public static final class IiImplingIcons {
      ...
      public static final int GOURMET = 867;
      public static final int BABY = 868;
      public static final int DRAGON = 869;
      public static final int NATURE = 870;
      public static final int ECLECTIC = 871;
      public static final int IMPLING_IN_JAR = 872;
      public static final int YOUNG = 873;
      public static final int MAGPIE = 874;
      public static final int ESSENCE = 875;
      public static final int EARTH = 876;
      public static final int NINJA = 877;
      public static final int LUCKY = 878;
   }
   ...
   public static final class GrimMusicalnotes {
      ...
      public static final int BEAMED = 862;
      public static final int CROTCHET = 863;
      public static final int MINIM = 864;
   }
   ...
   public static final class AchievementDiaryIcons {
      ...
      public static final int BLUE_QUESTS = 835;
      public static final int GREEN_ACHIEVEMENT_DIARIES = 836;
      public static final int RED_MINIGAMES = 1054;
      public static final int PURPLE_KOUREND = 1297;
      public static final int ORANGE_ADVENTURE_PATHS = 2219;
      public static final int BROWN_CHARACTER_SUMMARY = 2276;
   }
   ...
   public static final class WildDitchSignButton {
      ...
      public static final int BUTTON = 833;
      public static final int HOVERED = 834;
      public static final int HOVERED_WITH_RED_X = 943;
   }

   public static final class V2StoneCloseButton {
      public static final int _0 = 831;
      public static final int _1 = 832;
      public static final int BUTTON = 831;
      public static final int HOVERED = 832;
   }
   ...
   public static final class V2StoneBorders {
      ...
      public static final int SIDE_PANEL_EDGE_TOP = 820;
      public static final int SIDE_PANEL_EDGE_LEFT = 821;
      public static final int SIDE_PANEL_EDGE_BOTTOM = 822;
      public static final int SIDE_PANEL_EDGE_RIGHT = 823;
      public static final int SIDE_PANEL_CORNER_TOP_LEFT = 824;
      public static final int SIDE_PANEL_CORNER_TOP_RIGHT = 825;
      public static final int SIDE_PANEL_CORNER_BOTTOM_LEFT = 826;
      public static final int SIDE_PANEL_CORNER_BOTTOM_RIGHT = 827;
      public static final int SIDE_PANEL_EDGE_HORIZONTAL = 828;
      public static final int SIDE_PANEL_INTERSECTION_LEFT = 829;
      public static final int SIDE_PANEL_INTERSECTION_RIGHT = 830;
      public static final int SIDE_PANEL_INTERSECTION_BOTTOM = 839;
      public static final int SIDE_PANEL_INTERSECTION_TOP = 840;
      public static final int EDGE_VERTICAL = 841;
      public static final int INTERSECTION_TOP = 842;
      public static final int INTERSECTION_BOTTOM = 843;
      public static final int INTERSECTION_LEFT = 844;
      public static final int INTERSECTION_RIGHT = 845;
      public static final int CORNER_TOP_LEFT = 846;
      public static final int CORNER_TOP_RIGHT = 847;
      public static final int CORNER_BOTTOM_LEFT = 848;
      public static final int CORNER_BOTTOM_RIGHT = 849;
      public static final int INTERSECTION_MIDDLE = 850;
   }

   public static final class Combatboxesmed {
      public static final int _0 = 812;
      public static final int _1 = 813;
      public static final int BUTTON = 812;
      public static final int SELECTED = 813;
   }
   ...
   public static final class PengEmotes {
      ...
      public static final int SHIVER = 803;
      public static final int SPIN = 804;
      public static final int CLAP = 805;
      public static final int BOW = 806;
      public static final int CHEER = 807;
      public static final int WAVE = 808;
      public static final int PREEN = 809;
      public static final int FLAP = 810;
   }

   public static final class ScrollbarSep {
      public static final int _0 = 801;
      public static final int _1 = 802;
      public static final int ARROW_UP = 801;
      public static final int ARROW_DOWN = 802;
   }

   public static final class CloseButtonsV2 {
      public static final int _0 = 799;
      public static final int _1 = 800;
      public static final int BUTTON = 799;
      public static final int HOVERED = 800;
   }
   ...
   public static final class ScrollbarParchmentDraggerV2 {
      ...
      public static final int TOP = 795;
      public static final int MIDDLE = 796;
      public static final int BOTTOM = 797;
      public static final int TRACK = 798;
   }

   public static final class ScrollbarParchmentV2 {
      public static final int _0 = 793;
      public static final int _1 = 794;
      public static final int UP = 793;
      public static final int DOWN = 794;
   }
   ...
   public static final class ScrollbarDraggerV2 {
      ...
      public static final int TOP = 789;
      public static final int MIDDLE = 790;
      public static final int BOTTOM = 791;
      public static final int TRACK = 792;
   }
   ...
   public static final class SideiconsInterface {
      ...
      public static final int COMBAT = 774;
      public static final int STATS = 775;
      public static final int QUESTS = 776;
      public static final int INVENTORY = 777;
      public static final int EQUIPMENT = 778;
      public static final int PRAYER = 779;
      public static final int MAGIC = 780;
      public static final int CHAT_CHANNEL = 781;
      public static final int FRIENDS = 782;
      public static final int IGNORES = 783;
      public static final int LOGOUT = 784;
      public static final int OPTIONS = 785;
      public static final int EMOTES = 786;
      public static final int MUSIC = 787;
      public static final int MINIGAMES = 1053;
      public static final int ACHIEVEMENT_DIARIES = 1299;
      public static final int KOUREND = 1414;
      public static final int RAIDING_PARTY = 1582;
      public static final int SPELLBOOK_ANCIENT_MAGICKS = 1583;
      public static final int SPELLBOOK_LUNAR = 1584;
      public static final int SPELLBOOK_ARCEUUS = 1711;
      public static final int ADVENTURE_PATHS = 1713;
      public static final int CLAN = 2307;
      public static final int CHARACTER_SUMMARY = 2309;
   }
   ...
   public static final class ScrollbarV2 {
      ...
      public static final int ARROW_UP = 773;
      public static final int ARROW_DOWN = 788;
      public static final int ARROW_LEFT = 4533;
      public static final int ARROW_RIGHT = 4534;
   }
   ...
   public static final class BarbassaultIcons {
      ...
      public static final int WAVE = 765;
      public static final int EAR = 766;
      public static final int MOUTH = 767;
      public static final int HORN_FOR_ATTACKER = 768;
      public static final int HORN_FOR_DEFENDER = 769;
      public static final int HORN_FOR_COLLECTOR = 770;
      public static final int HORN_FOR_HEALER = 771;
   }

   public static final class OptionsBoxes {
      public static final int _0 = 761;
      public static final int _1 = 762;
      public static final int EMPTY = 761;
      public static final int SELECTED = 762;
   }
   ...
   public static final class EmotesLocked {
      ...
      public static final int SHRUG = 740;
      public static final int BLOW_KISS = 741;
      public static final int GLASS_BOX = 742;
      public static final int CLIMB_ROPE = 743;
      public static final int LEAN = 744;
      public static final int GLASS_WALL = 745;
      public static final int GOBLIN_BOW = 746;
      public static final int GOBLIN_SALUTE = 747;
      public static final int SCARED = 748;
      public static final int SLAP_HEAD = 749;
      public static final int STAMP = 750;
      public static final int FLAP = 751;
      public static final int IDEA = 752;
      public static final int ZOMBIE_WALK = 753;
      public static final int ZOMBIE_DANCE = 754;
      public static final int RABBIT_HOP = 755;
      public static final int SKILLCAPE = 756;
      public static final int ZOMBIE_HAND = 757;
      public static final int AIR_GUITAR = 758;
      public static final int JOG = 759;
      public static final int SIT_UP = 1206;
      public static final int STAR_JUMP = 1207;
      public static final int PUSH_UP = 1208;
      public static final int HYPERMOBILE_DRINKER = 1209;
      public static final int URI_TRANSFORM = 1354;
      public static final int SMOOTH_DANCE = 1355;
      public static final int CRAZY_DANCE = 1356;
      public static final int PREMIER_SHIELD = 1357;
      public static final int FORTIS_SALUTE = 5251;
   }
   ...
   public static final class Emotes {
      ...
      public static final int YES = 700;
      public static final int NO = 701;
      public static final int THINK = 702;
      public static final int BOW = 703;
      public static final int ANGRY = 704;
      public static final int CRY = 705;
      public static final int LAUGH = 706;
      public static final int CHEER = 707;
      public static final int WAVE = 708;
      public static final int BECKON = 709;
      public static final int DANCE = 710;
      public static final int CLAP = 711;
      public static final int PANIC = 712;
      public static final int JIG = 713;
      public static final int SPIN = 714;
      public static final int HEADBANG = 715;
      public static final int JUMP_FOR_JOY = 716;
      public static final int RASPBERRY = 717;
      public static final int YAWN = 718;
      public static final int SALUTE = 719;
      public static final int SHRUG = 720;
      public static final int BLOW_KISS = 721;
      public static final int GLASS_BOX = 722;
      public static final int CLIMB_ROPE = 723;
      public static final int LEAN = 724;
      public static final int GLASS_WALL = 725;
      public static final int GOBLIN_BOW = 726;
      public static final int GOBLIN_SALUTE = 727;
      public static final int SCARED = 728;
      public static final int SLAP_HEAD = 729;
      public static final int STAMP = 730;
      public static final int FLAP = 731;
      public static final int IDEA = 732;
      public static final int ZOMBIE_WALK = 733;
      public static final int ZOMBIE_DANCE = 734;
      public static final int RABBIT_HOP = 735;
      public static final int SKILLCAPE = 736;
      public static final int ZOMBIE_HAND = 737;
      public static final int AIR_GUITAR = 738;
      public static final int JOG = 739;
      public static final int SIT_UP = 1202;
      public static final int STAR_JUMP = 1203;
      public static final int PUSH_UP = 1204;
      public static final int HYPERMOBILE_DRINKER = 1205;
      public static final int URI_TRANSFORM = 1350;
      public static final int SMOOTH_DANCE = 1351;
      public static final int CRAZY_DANCE = 1352;
      public static final int PREMIER_SHIELD = 1353;
      public static final int FORTIS_SALUTE = 5246;
      public static final int CRAB_DANCE = 5245;
   }
   ...
   public static final class OptionsRadioButtons {
      ...
      public static final int EMPTY = 697;
      public static final int CROSS_RED = 698;
      public static final int CHECK_GREEN = 699;
      public static final int CHECK_RED = 1192;
      public static final int EMPTY_HOVER = 1211;
      public static final int CROSS_RED_HOVER = 1212;
      public static final int CHECK_GREEN_HOVER = 1213;
      public static final int CHECK_RED_HOVER = 1214;
   }
   ...
   public static final class OptionsSliderFive {
      ...
      public static final int THUMB_1_OF_5 = 687;
      public static final int THUMB_2_OF_5 = 688;
      public static final int THUMB_3_OF_5 = 689;
      public static final int THUMB_4_OF_5 = 690;
      public static final int THUMB_5_OF_5 = 691;
      public static final int _1_OF_5 = 692;
      public static final int _2_OF_5 = 693;
      public static final int _3_OF_5 = 694;
      public static final int _4_OF_5 = 695;
      public static final int _5_OF_5 = 696;
   }
   ...
   public static final class OptionsSlider {
      ...
      public static final int _1_OF_4 = 679;
      public static final int _2_OF_4 = 680;
      public static final int _3_OF_4 = 681;
      public static final int _4_OF_4 = 682;
      public static final int THUMB_1_OF_4 = 683;
      public static final int THUMB_2_OF_4 = 684;
      public static final int THUMB_3_OF_4 = 685;
      public static final int THUMB_4_OF_4 = 686;
   }
   ...
   public static final class OptionsIcons {
      ...
      public static final int SCREEN_BRIGHTNESS = 659;
      public static final int MUSIC_VOLUME = 660;
      public static final int SOUND_EFFECT_VOLUME = 661;
      public static final int CHAT_EFFECTS = 662;
      public static final int MOUSE_BUTTONS = 663;
      public static final int SPLIT_PRIVATE_CHAT = 664;
      public static final int ACCEPT_AID = 665;
      public static final int MUSIC_DISABLED = 666;
      public static final int SOUND_EFFECTS_DISABLED = 667;
      public static final int UNKNOWN_SWORD_GRIP = 668;
      public static final int WALKING = 669;
      public static final int RUNNING = 670;
      public static final int WALKING_DISABLED = 671;
      public static final int RUNNING_DISABLED = 672;
      public static final int AREA_SOUND_VOLUME = 673;
      public static final int AREA_SOUND_DISABLED = 674;
      public static final int EQUIPMENT_EQUIPMENT_STATS = 675;
      public static final int HOUSE_OPTIONS = 676;
      public static final int EQUIPMENT_ITEMS_LOST_ON_DEATH = 912;
      public static final int PROFANITY_FILTER = 1045;
      public static final int DATA_ORBS = 1057;
      public static final int CAMERA = 1073;
      public static final int DISPLAY = 1084;
      public static final int CHAT = 1085;
      public static final int ROOFS = 1086;
      public static final int XP_TO_NEXT_LEVEL = 1087;
      public static final int CONTROLS = 1088;
      public static final int LOGIN_LOGOUT_NOTIFICATION_TIMEOUT = 1089;
      public static final int EQUIPMENT_GUIDE_PRICES = 1090;
      public static final int SIDE_PANELS = 1091;
      public static final int TRANSPARENT_CHATBOX = 1159;
      public static final int TRANSPARENT_SIDE_PANEL = 1160;
      public static final int KEYBINDINGS = 1161;
      public static final int SCROLL_WHEEL_ZOOM = 1162;
      public static final int HIDE_PRIVATE_CHAT = 1163;
      public static final int NOTIFICATIONS = 1164;
      public static final int SHIFT_CLICK_DROP = 1165;
      public static final int FOLLOWER_RIGHT_CLICK_MENU = 1166;
      public static final int PRAYER_TOOLTIPS = 1167;
      public static final int SPECIAL_ATTACK_TOOLTIP = 1168;
      public static final int FINGER_POINTING_AT_MENU = 1562;
      public static final int DISPLAY_ICON_VERTICAL = 1563;
      public static final int F1_BUTTON_DISABLED = 1564;
      public static final int TWO_FINGERS_POINTING_AT_MAGNIFYING_GLASS = 1565;
      public static final int SHIFT_KEY_DISABLED = 1566;
      public static final int FINGER_POINTING_AT_PET = 1567;
      public static final int SCROLL = 1568;
   ...
   public static final class CombatboxesVeryLarge {
      ...
      public static final int BUTTON = 655;
      public static final int SELECTED = 656;
   }

   public static final class CombatboxesLarge {
      public static final int _0 = 653;
      public static final int _1 = 654;
      public static final int BUTTON = 653;
      public static final int SELECTED = 654;
   }
   ...
   public static final class OptionsIconsSmall {
      ...
      public static final int PRAYER = 651;
      public static final int RUN_ENERGY = 677;
      public static final int SOUND = 911;
      public static final int FRIENDS = 1702;
      public static final int IGNORES = 1703;
   }
   ...
   public static final class LunarMagicOff {
      ...
      public static final int BAKE_PIE = 593;
      public static final int MOONCLAN_TELEPORT = 594;
      public static final int WATERBIRTH_TELEPORT = 595;
      public static final int BOW_AND_ARROW = 596;
      public static final int BARBARIAN_TELEPORT = 597;
      public static final int SUPERGLASS_MAKE = 598;
      public static final int KHAZARD_TELEPORT = 599;
      public static final int STRING_JEWELLERY = 600;
      public static final int BOOST_POTION_SHARE = 601;
      public static final int MAGIC_IMBUE = 602;
      public static final int FERTILE_SOIL = 603;
      public static final int STAT_RESTORE_POT_SHARE = 604;
      public static final int FISHING_GUILD_TELEPORT = 605;
      public static final int CATHERBY_TELEPORT = 606;
      public static final int ICE_PLATEAU_TELEPORT = 607;
      public static final int ENERGY_TRANSFER = 608;
      public static final int CURE_OTHER = 609;
      public static final int HEAL_OTHER = 610;
      public static final int VENGEANCE_OTHER = 611;
      public static final int CURE_ME = 612;
      public static final int GEOMANCY = 613;
      public static final int VENGEANCE = 614;
      public static final int CURE_GROUP = 615;
      public static final int HEAL_GROUP = 616;
      public static final int CURE_PLANT = 617;
      public static final int NPC_CONTACT = 618;
      public static final int TELE_GROUP_MOONCLAN = 619;
      public static final int TELE_GROUP_WATERBIRTH = 620;
      public static final int TELE_GROUP_BARBARIAN = 621;
      public static final int TELE_GROUP_KHAZARD = 622;
      public static final int TELE_GROUP_FISHING_GUILD = 623;
      public static final int TELE_GROUP_CATHERBY = 624;
      public static final int TELE_GROUP_ICE_PLATEAU = 625;
      public static final int STAT_SPY = 626;
      public static final int MONSTER_EXAMINE = 627;
      public static final int HUMIDIFY = 628;
      public static final int HUNTER_KIT = 629;
      public static final int DREAM = 630;
      public static final int PLANK_MAKE = 631;
      public static final int SPELLBOOK_SWAP = 632;
      public static final int TAN_LEATHER = 633;
      public static final int RECHARGE_DRAGONSTONE = 634;
      public static final int SPIN_FLAX = 635;
      public static final int OURANIA_TELEPORT = 636;
   }
   ...
   public static final class LunarMagicOn {
      ...
      public static final int BAKE_PIE = 543;
      public static final int MOONCLAN_TELEPORT = 544;
      public static final int WATERBIRTH_TELEPORT = 545;
      public static final int BOW_AND_ARROW = 546;
      public static final int BARBARIAN_TELEPORT = 547;
      public static final int SUPERGLASS_MAKE = 548;
      public static final int KHAZARD_TELEPORT = 549;
      public static final int STRING_JEWELLERY = 550;
      public static final int BOOST_POTION_SHARE = 551;
      public static final int MAGIC_IMBUE = 552;
      public static final int FERTILE_SOIL = 553;
      public static final int STAT_RESTORE_POT_SHARE = 554;
      public static final int FISHING_GUILD_TELEPORT = 555;
      public static final int CATHERBY_TELEPORT = 556;
      public static final int ICE_PLATEAU_TELEPORT = 557;
      public static final int ENERGY_TRANSFER = 558;
      public static final int CURE_OTHER = 559;
      public static final int HEAL_OTHER = 560;
      public static final int VENGEANCE_OTHER = 561;
      public static final int CURE_ME = 562;
      public static final int GEOMANCY = 563;
      public static final int VENGEANCE = 564;
      public static final int CURE_GROUP = 565;
      public static final int HEAL_GROUP = 566;
      public static final int CURE_PLANT = 567;
      public static final int NPC_CONTACT = 568;
      public static final int TELE_GROUP_MOONCLAN = 569;
      public static final int TELE_GROUP_WATERBIRTH = 570;
      public static final int TELE_GROUP_BARBARIAN = 571;
      public static final int TELE_GROUP_KHAZARD = 572;
      public static final int TELE_GROUP_FISHING_GUILD = 573;
      public static final int TELE_GROUP_CATHERBY = 574;
      public static final int TELE_GROUP_ICE_PLATEAU = 575;
      public static final int STAT_SPY = 576;
      public static final int MONSTER_EXAMINE = 577;
      public static final int HUMIDIFY = 578;
      public static final int HUNTER_KIT = 579;
      public static final int DREAM = 580;
      public static final int PLANK_MAKE = 581;
      public static final int SPELLBOOK_SWAP = 582;
      public static final int TAN_LEATHER = 583;
      public static final int RECHARGE_DRAGONSTONE = 584;
      public static final int SPIN_FLAX = 585;
      public static final int OURANIA_TELEPORT = 586;
   }
   ...
   public static final class CloseButtons {
      ...
      public static final int BUTTON = 535;
      public static final int HOVERED = 536;
      public static final int PARCHMENT = 537;
      public static final int PARCHMENT_HOVERED = 538;
      public static final int RED_X = 539;
      public static final int RED_X_HOVERED = 540;
      public static final int BROWN_X = 541;
      public static final int BROWN_X_HOVERED = 542;
   }
   ...
   public static final class MapdotsInterface {
      ...
      public static final int RED_ITEM = 510;
      public static final int YELLOW_NPC = 511;
      public static final int WHITE_PLAYER = 512;
      public static final int GREEN_PLAYER_FRIEND = 513;
      public static final int BLUE_PLAYER_TEAM_CAPE = 514;
      public static final int PURPLE_PLAYER_FRIENDS_CHAT = 1044;
   }

   public static final class RedGreenArrows {
      public static final int _0 = 489;
      public static final int _1 = 534;
      public static final int GREEN_UP = 489;
      public static final int RED_DOWN = 534;
   }
   ...
   public static final class Magicoff2 {
      ...
      public static final int BIND = 369;
      public static final int SNARE = 370;
      public static final int ENTANGLE = 371;
      public static final int CHARGE = 372;
      public static final int TROLLHEIM_TELEPORT = 373;
      public static final int MAGIC_DART = 374;
      public static final int ICE_RUSH = 375;
      public static final int ICE_BURST = 376;
      public static final int ICE_BLITZ = 377;
      public static final int ICE_BARRAGE = 378;
      public static final int SMOKE_RUSH = 379;
      public static final int SMOKE_BURST = 380;
      public static final int SMOKE_BLITZ = 381;
      public static final int SMOKE_BARRAGE = 382;
      public static final int BLOOD_RUSH = 383;
      public static final int BLOOD_BURST = 384;
      public static final int BLOOD_BLITZ = 385;
      public static final int BLOOD_BARRAGE = 386;
      public static final int SHADOW_RUSH = 387;
      public static final int SHADOW_BURST = 388;
      public static final int SHADOW_BLITZ = 389;
      public static final int SHADOW_BARRAGE = 390;
      public static final int PADDEWWA_TELEPORT = 391;
      public static final int SENNTISTEN_TELEPORT = 392;
      public static final int KHARYRLL_TELEPORT = 393;
      public static final int LASSAR_TELEPORT = 394;
      public static final int DAREEYAK_TELEPORT = 395;
      public static final int CARRALLANGAR_TELEPORT = 396;
      public static final int ANNAKARL_TELEPORT = 397;
      public static final int GHORROCK_TELEPORT = 398;
      public static final int TELEOTHER_LUMBRIDGE = 399;
      public static final int TELEOTHER_FALADOR = 400;
      public static final int TELEOTHER_CAMELOT = 401;
      public static final int TELE_BLOCK = 402;
      public static final int LVL_6_ENCHANT = 403;
      public static final int BONES_TO_PEACHES = 404;
      public static final int TELEPORT_TO_HOUSE = 405;
      public static final int LUMBRIDGE_HOME_TELEPORT = 406;
      public static final int TELEPORT_TO_APE_ATOLL = 407;
      public static final int ENCHANT_CROSSBOW_BOLT = 408;
      public static final int TELEPORT_TO_BOUNTY_TARGET = 409;
      public static final int TELEPORT_TO_KOUREND = 410;
      public static final int LVL_7_ENCHANT = 411;
      public static final int WIND_SURGE = 412;
      public static final int WATER_SURGE = 413;
      public static final int EARTH_SURGE = 414;
      public static final int FIRE_SURGE = 415;
   }
   ...
   public static final class Magicon2 {
      ...
      public static final int BIND = 319;
      public static final int SNARE = 320;
      public static final int ENTANGLE = 321;
      public static final int CHARGE = 322;
      public static final int TROLLHEIM_TELEPORT = 323;
      public static final int MAGIC_DART = 324;
      public static final int ICE_RUSH = 325;
      public static final int ICE_BURST = 326;
      public static final int ICE_BLITZ = 327;
      public static final int ICE_BARRAGE = 328;
      public static final int SMOKE_RUSH = 329;
      public static final int SMOKE_BURST = 330;
      public static final int SMOKE_BLITZ = 331;
      public static final int SMOKE_BARRAGE = 332;
      public static final int BLOOD_RUSH = 333;
      public static final int BLOOD_BURST = 334;
      public static final int BLOOD_BLITZ = 335;
      public static final int BLOOD_BARRAGE = 336;
      public static final int SHADOW_RUSH = 337;
      public static final int SHADOW_BURST = 338;
      public static final int SHADOW_BLITZ = 339;
      public static final int SHADOW_BARRAGE = 340;
      public static final int PADDEWWA_TELEPORT = 341;
      public static final int SENNTISTEN_TELEPORT = 342;
      public static final int KHARYRLL_TELEPORT = 343;
      public static final int LASSAR_TELEPORT = 344;
      public static final int DAREEYAK_TELEPORT = 345;
      public static final int CARRALLANGAR_TELEPORT = 346;
      public static final int ANNAKARL_TELEPORT = 347;
      public static final int GHORROCK_TELEPORT = 348;
      public static final int TELEOTHER_LUMBRIDGE = 349;
      public static final int TELEOTHER_FALADOR = 350;
      public static final int TELEOTHER_CAMELOT = 351;
      public static final int TELE_BLOCK = 352;
      public static final int LVL_6_ENCHANT = 353;
      public static final int BONES_TO_PEACHES = 354;
      public static final int TELEPORT_TO_HOUSE = 355;
      public static final int LUMBRIDGE_HOME_TELEPORT = 356;
      public static final int TELEPORT_TO_APE_ATOLL = 357;
      public static final int ENCHANT_CROSSBOW_BOLT = 358;
      public static final int TELEPORT_TO_BOUNTY_TARGET = 359;
      public static final int TELEPORT_TO_KOUREND = 360;
      public static final int LVL_7_ENCHANT = 361;
      public static final int WIND_SURGE = 362;
      public static final int WATER_SURGE = 363;
      public static final int EARTH_SURGE = 364;
      public static final int FIRE_SURGE = 365;
      public static final int CIVITAS_ILLA_FORTIS_TELEPORT = 367;
   }

   public static final class Steelborder2 {
      public static final int _0 = 314;
      public static final int _1 = 315;
      public static final int EDGE_TOP = 314;
      public static final int EDGE_RIGHT = 315;
   }
   ...
   public static final class Steelborder {
      ...
      public static final int TOP_LEFT = 310;
      public static final int TOP_RIGHT = 311;
      public static final int BOTTOM_LEFT = 312;
      public static final int BOTTOM_RIGHT = 313;
   }
   ...
   public static final class Sworddecor {
      ...
      public static final int RIGHT = 302;
      public static final int RIGHT_SHADOWED = 303;
      public static final int LEFT_SHADOWED = 304;
   }
   ...
   public static final class HeadiconsPkInterface {
      ...
      public static final int PLAYER_KILLER_SKULL = 523;
   ...
   public static final class Combatboxes {
      ...
      public static final int BUTTON_NARROW = 293;
      public static final int BUTTON_NARROW_SELECTED = 294;
      public static final int BUTTON_THIN = 295;
      public static final int BUTTON_THIN_SELECTED = 296;
   }
   ...
   public static final class Combaticons3 {
      ...
      public static final int PICKAXE_BLOCK = 273;
      public static final int PICKAXE_SPIKE = 274;
      public static final int PICKAXE_SMASH = 275;
      public static final int PICKAXE_IMPALE = 276;
      public static final int CLAWS_LUNGE = 277;
      public static final int CLAWS_SLASH = 278;
      public static final int CLAWS_CHOP = 279;
      public static final int CLAWS_BLOCK = 280;
      public static final int CHINCHOMPA_LONG_FUSE = 281;
      public static final int CHINCHOMPA_MEDIUM_FUSE = 282;
      public static final int HALBERD_BLOCK = 283;
      public static final int HALBERD_JAB = 284;
      public static final int HALBERD_SWIPE = 285;
      public static final int WHIP_FLICK = 286;
      public static final int WHIP_LASH = 287;
      public static final int CHINCHOMPA_SHORT_FUSE = 288;
      public static final int SALAMANDER_SCORCH = 289;
      public static final int SALAMANDER_FLARE = 290;
      public static final int SALAMANDER_BLAZE = 291;
   }
   ...
   public static final class Combaticons2 {
      ...
      public static final int HAMMER_BLOCK = 253;
      public static final int HAMMER = 254;
      public static final int HAMMER_POUND = 255;
      public static final int HAMMER_PUMMEL = 256;
      public static final int STAKE = 257;
      public static final int CROSSBOW_ACCURATE = 258;
      public static final int CROSSBOW_RAPID = 259;
      public static final int CROSSBOW_LONGRANGE = 260;
      public static final int SCYTHE_BLOCK = 261;
      public static final int SCYTHE_CHOP = 262;
      public static final int MAGIC_ACCURATE = 263;
      public static final int MAGIC_RAPID = 264;
      public static final int MAGIC_LONGRANGE = 265;
      public static final int STAFF_BASH = 266;
      public static final int STAFF_POUND = 267;
      public static final int BOW_ACCURATE = 268;
      public static final int BOW_RAPID = 269;
      public static final int BOW_LONGRANGE = 270;
      public static final int SCYTHE_JAB = 271;
      public static final int SCYTHE_REAP = 272;
   }
   ...
   public static final class Combaticons {
      ...
      public static final int AXE_BLOCK = 233;
      public static final int AXE_CHOP = 234;
      public static final int AXE_HACK = 235;
      public static final int AXE_SMASH = 236;
      public static final int SWORD_BLOCK = 237;
      public static final int SWORD_SLASH = 238;
      public static final int SWORD_CHOP = 239;
      public static final int SWORD_STAB = 240;
      public static final int SPEAR_LUNGE = 241;
      public static final int SPEAR_POUND = 242;
      public static final int MACE_BLOCK = 243;
      public static final int MACE_PUMMEL = 244;
      public static final int MACE_SPIKE = 245;
      public static final int MACE_POUND = 246;
      public static final int UNARMED_PUNCH = 247;
      public static final int UNARMED_KICK = 248;
      public static final int UNARMED_BLOCK = 249;
      public static final int SPEAR_BLOCK = 250;
      public static final int SPEAR_SWIPE = 251;
      public static final int STAFF_BLOCK = 252;
   }
   ...
   public static final class Staticons2 {
      ...
      public static final int RUNECRAFT = 215;
      public static final int SLAYER = 216;
      public static final int FARMING = 217;
      public static final int SHOVEL = 218;
      public static final int RAT_PITS_ZONE_RAT = 219;
      public static final int HUNTER = 220;
      public static final int CONSTRUCTION = 221;
      public static final int TOTAL = 222;
      public static final int UNKNOWN_EMPTY_VIAL = 223;
      public static final int UNKNOWN_DRAGON_DAGGER_P = 224;
      public static final int SAILING = 228;
   }
   ...
   public static final class Staticons {
      ...
      public static final int ATTACK = 197;
      public static final int STRENGTH = 198;
      public static final int DEFENCE = 199;
      public static final int RANGED = 200;
      public static final int PRAYER = 201;
      public static final int MAGIC = 202;
      public static final int HITPOINTS = 203;
      public static final int AGILITY = 204;
      public static final int HERBLORE = 205;
      public static final int THIEVING = 206;
      public static final int CRAFTING = 207;
      public static final int FLETCHING = 208;
      public static final int MINING = 209;
      public static final int SMITHING = 210;
      public static final int FISHING = 211;
      public static final int COOKING = 212;
      public static final int FIREMAKING = 213;
      public static final int WOODCUTTING = 214;
   }
   ...
   public static final class SideIcons {
      ...
      public static final int COMBAT = 168;
      public static final int STATS = 898;
      public static final int QUEST = 899;
      public static final int INVENTORY = 900;
      public static final int EQUIPMENT = 901;
      public static final int MAGIC = 903;
      public static final int FRIENDS_CHAT = 904;
      public static final int LOGOUT = 907;
      public static final int OPTIONS = 908;
      public static final int EMOTES = 909;
      public static final int MUSIC = 910;
      public static final int HOUSE = 1055;
      public static final int MINIGAMES = 1056;
      public static final int ACHIEVEMENT_DIARIES = 1298;
      public static final int KOUREND = 1413;
      public static final int RAIDING_PARTY = 1579;
      public static final int SPELLBOOK_ANCIENT_MAGICKS = 1580;
      public static final int SPELLBOOK_LUNAR = 1581;
      public static final int SPELLBOOK_ARCEUUS = 1708;
   }
   ...
   public static final class Wornicons {
      ...
      public static final int HEAD = 156;
      public static final int CAPE = 157;
      public static final int NECK = 158;
      public static final int WEAPON = 159;
      public static final int RING = 160;
      public static final int TORSO = 161;
      public static final int SHIELD = 162;
      public static final int LEGS = 163;
      public static final int HANDS = 164;
      public static final int FEET = 165;
      public static final int AMMUNITION = 166;
   }
   ...
   public static final class GeItembackdrop {
      ...
      public static final int BOX = 1120;
      public static final int GLOWING = 1121;
   }
   ...
   public static final class Prayeroff {
      ...
      public static final int THICK_SKIN_DISABLED = 135;
      public static final int BURST_OF_STRENGTH_DISABLED = 136;
      public static final int CLARITY_OF_THOUGHT_DISABLED = 137;
      public static final int ROCK_SKIN_DISABLED = 138;
      public static final int SUPERHUMAN_STRENGTH_DISABLED = 139;
      public static final int IMPROVED_REFLEXES_DISABLED = 140;
      public static final int RAPID_RESTORE_DISABLED = 141;
      public static final int RAPID_HEAL_DISABLED = 142;
      public static final int PROTECT_ITEM_DISABLED = 143;
      public static final int STEEL_SKIN_DISABLED = 144;
      public static final int ULTIMATE_STRENGTH_DISABLED = 145;
      public static final int INCREDIBLE_REFLEXES_DISABLED = 146;
      public static final int PROTECT_FROM_MAGIC_DISABLED = 147;
      public static final int PROTECT_FROM_MISSILES_DISABLED = 148;
      public static final int PROTECT_FROM_MELEE_DISABLED = 149;
      public static final int REDEMPTION_DISABLED = 150;
      public static final int RETRIBUTION_DISABLED = 151;
      public static final int SMITE_DISABLED = 152;
      public static final int SHARP_EYE_DISABLED = 153;
      public static final int MYSTIC_WILL_DISABLED = 154;
      public static final int HAWK_EYE_DISABLED = 506;
      public static final int MYSTIC_LORE_DISABLED = 507;
      public static final int EAGLE_EYE_DISABLED = 508;
      public static final int MYSTIC_MIGHT_DISABLED = 509;
      public static final int PROTECT_FROM_SUMMONING_DISABLED = 948;
      public static final int CHIVALRY_DISABLED = 949;
      public static final int PIETY_DISABLED = 950;
      public static final int PRESERVE_DISABLED = 951;
      public static final int RIGOUR_DISABLED = 1424;
      public static final int AUGURY_DISABLED = 1425;
      public static final int DEADEYE_DISABLED = 1426;
      public static final int MYSTIC_VIGOUR_DISABLED = 1427;
   }
   ...
   public static final class Prayeron {
      ...
      public static final int THICK_SKIN = 115;
      public static final int BURST_OF_STRENGTH = 116;
      public static final int CLARITY_OF_THOUGHT = 117;
      public static final int ROCK_SKIN = 118;
      public static final int SUPERHUMAN_STRENGTH = 119;
      public static final int IMPROVED_REFLEXES = 120;
      public static final int RAPID_RESTORE = 121;
      public static final int RAPID_HEAL = 122;
      public static final int PROTECT_ITEM = 123;
      public static final int STEEL_SKIN = 124;
      public static final int ULTIMATE_STRENGTH = 125;
      public static final int INCREDIBLE_REFLEXES = 126;
      public static final int PROTECT_FROM_MAGIC = 127;
      public static final int PROTECT_FROM_MISSILES = 128;
      public static final int PROTECT_FROM_MELEE = 129;
      public static final int REDEMPTION = 130;
      public static final int RETRIBUTION = 131;
      public static final int SMITE = 132;
      public static final int SHARP_EYE = 133;
      public static final int MYSTIC_WILL = 134;
      public static final int HAWK_EYE = 502;
      public static final int MYSTIC_LORE = 503;
      public static final int EAGLE_EYE = 504;
      public static final int MYSTIC_MIGHT = 505;
      public static final int PROTECT_FROM_SUMMONING = 944;
      public static final int CHIVALRY = 945;
      public static final int PIETY = 946;
      public static final int PRESERVE = 947;
      public static final int RIGOUR = 1420;
      public static final int AUGURY = 1421;
      public static final int DEADEYE = 1422;
      public static final int MYSTIC_VIGOUR = 1423;
   }
   ...
   public static final class Magicoff {
      ...
      public static final int WIND_STRIKE = 65;
      public static final int CONFUSE = 66;
      public static final int WATER_STRIKE = 67;
      public static final int LVL_1_ENCHANT = 68;
      public static final int EARTH_STRIKE = 69;
      public static final int WEAKEN = 70;
      public static final int FIRE_STRIKE = 71;
      public static final int BONES_TO_BANANAS = 72;
      public static final int WIND_BOLT = 73;
      public static final int CURSE = 74;
      public static final int LOW_LEVEL_ALCHEMY = 75;
      public static final int WATER_BOLT = 76;
      public static final int VARROCK_TELEPORT = 77;
      public static final int LVL_2_ENCHANT = 78;
      public static final int EARTH_BOLT = 79;
      public static final int LUMBRIDGE_TELEPORT = 80;
      public static final int TELEKINETIC_GRAB = 81;
      public static final int FIRE_BOLT = 82;
      public static final int FALADOR_TELEPORT = 83;
      public static final int CRUMBLE_UNDEAD = 84;
      public static final int WIND_BLAST = 85;
      public static final int SUPERHEAT_ITEM = 86;
      public static final int CAMELOT_TELEPORT = 87;
      public static final int WATER_BLAST = 88;
      public static final int LVL_3_ENCHANT = 89;
      public static final int EARTH_BLAST = 90;
      public static final int HIGH_LEVEL_ALCHEMY = 91;
      public static final int CHARGE_WATER_ORB = 92;
      public static final int LVL_4_ENCHANT = 93;
      public static final int FIRE_BLAST = 94;
      public static final int CHARGE_EARTH_ORB = 95;
      public static final int WIND_WAVE = 96;
      public static final int CHARGE_FIRE_ORB = 97;
      public static final int WATER_WAVE = 98;
      public static final int CHARGE_AIR_ORB = 99;
      public static final int LVL_5_ENCHANT = 100;
      public static final int EARTH_WAVE = 101;
      public static final int FIRE_WAVE = 102;
      public static final int IBAN_BLAST = 103;
      public static final int ARDOUGNE_TELEPORT = 104;
      public static final int WATCHTOWER_TELEPORT = 105;
      public static final int VULNERABILITY = 106;
      public static final int ENFEEBLE = 107;
      public static final int STUN = 108;
      public static final int FLAMES_OF_ZAMORAK = 109;
      public static final int CLAWS_OF_GUTHIX = 110;
      public static final int SARADOMIN_STRIKE = 111;
      public static final int CALL_ANIMAL = 112;
      public static final int RAISE_SKELETON = 113;
      public static final int SUMMON_DEMON = 114;
   }
   ...
   public static final class Magicon {
      ...
      public static final int WIND_STRIKE = 15;
      public static final int CONFUSE = 16;
      public static final int WATER_STRIKE = 17;
      public static final int LVL_1_ENCHANT = 18;
      public static final int EARTH_STRIKE = 19;
      public static final int WEAKEN = 20;
      public static final int FIRE_STRIKE = 21;
      public static final int BONES_TO_BANANAS = 22;
      public static final int WIND_BOLT = 23;
      public static final int CURSE = 24;
      public static final int LOW_LEVEL_ALCHEMY = 25;
      public static final int WATER_BOLT = 26;
      public static final int VARROCK_TELEPORT = 27;
      public static final int LVL_2_ENCHANT = 28;
      public static final int EARTH_BOLT = 29;
      public static final int LUMBRIDGE_TELEPORT = 30;
      public static final int TELEKINETIC_GRAB = 31;
      public static final int FIRE_BOLT = 32;
      public static final int FALADOR_TELEPORT = 33;
      public static final int CRUMBLE_UNDEAD = 34;
      public static final int WIND_BLAST = 35;
      public static final int SUPERHEAT_ITEM = 36;
      public static final int CAMELOT_TELEPORT = 37;
      public static final int WATER_BLAST = 38;
      public static final int LVL_3_ENCHANT = 39;
      public static final int EARTH_BLAST = 40;
      public static final int HIGH_LEVEL_ALCHEMY = 41;
      public static final int CHARGE_WATER_ORB = 42;
      public static final int LVL_4_ENCHANT = 43;
      public static final int FIRE_BLAST = 44;
      public static final int CHARGE_EARTH_ORB = 45;
      public static final int WIND_WAVE = 46;
      public static final int CHARGE_FIRE_ORB = 47;
      public static final int WATER_WAVE = 48;
      public static final int CHARGE_AIR_ORB = 49;
      public static final int LVL_5_ENCHANT = 50;
      public static final int EARTH_WAVE = 51;
      public static final int FIRE_WAVE = 52;
      public static final int IBAN_BLAST = 53;
      public static final int ARDOUGNE_TELEPORT = 54;
      public static final int WATCHTOWER_TELEPORT = 55;
      public static final int VULNERABILITY = 56;
      public static final int ENFEEBLE = 57;
      public static final int STUN = 58;
      public static final int FLAMES_OF_ZAMORAK = 59;
      public static final int CLAWS_OF_GUTHIX = 60;
      public static final int SARADOMIN_STRIKE = 61;
      public static final int CALL_ANIMAL = 62;
      public static final int RAISE_SKELETON = 63;
      public static final int SUMMON_DEMON = 64;
   }
