...
public class RegenMeterPlugin extends Plugin {
   ...
   public void onGameTick(GameTick event) {
      ...
      if (this.client.getVarpValue(300) == 1000) {
         this.ticksSinceSpecRegen = 0;
      } else {
         this.ticksSinceSpecRegen = (this.ticksSinceSpecRegen + 1) % ticksPerSpecRegen;
      }
      ...
      if (currentHP == maxHP && !this.config.showWhenNoChange()) {
