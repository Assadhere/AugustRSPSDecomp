...
class XpPanel extends PluginPanel {
   ...
   XpPanel(XpTrackerPlugin xpTrackerPlugin, final XpTrackerConfig xpTrackerConfig, Client client, SkillIconManager iconManager) {
      ...
      openXpTracker.addActionListener((e) -> {
         LinkBrowser.browse(buildXpTrackerUrl(client.getWorldType(), client.getLocalPlayer(), (Skill)null));
      });
      ...
      unpauseAll.addActionListener((e) -> {
      ...
      this.overallPanel.add(overallInfo, "Center");
      ...
      Skill[] var16 = Skill.values();
      int var17 = var16.length;

      for(int var18 = 0; var18 < var17; ++var18) {
         Skill skill = var16[var18];
   ...
   void resetSkill(Skill skill) {
      XpInfoBox xpInfoBox = (XpInfoBox)this.infoBoxes.get(skill);
      xpInfoBox.reset();
   }
   ...
   void updateTotal(XpSnapshotSingle xpSnapshotTotal) {
      ...
      SwingUtilities.invokeLater(() -> {
         this.rebuildAsync(xpSnapshotTotal);
      });
   }
