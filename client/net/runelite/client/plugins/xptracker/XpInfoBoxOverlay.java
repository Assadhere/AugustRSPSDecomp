...
class XpInfoBoxOverlay extends OverlayPanel {
   ...
   XpInfoBoxOverlay(XpTrackerPlugin plugin, XpTrackerConfig config, Skill skill, BufferedImage icon) {
      ...
      this.iconXpSplitPanel.setBackgroundColor((Color)null);
   ...
   public Dimension render(Graphics2D graphics) {
      ...
      String rightNum = (String)this.config.onScreenDisplayMode().getValueFunc().apply(snapshot);
      ...
      String bottomRightNum = (String)this.config.onScreenDisplayModeBottom().getValueFunc().apply(snapshot);
