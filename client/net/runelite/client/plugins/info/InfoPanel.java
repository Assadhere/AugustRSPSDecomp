...
public class InfoPanel extends PluginPanel {
   ...
   void init() {
      ...
      JLabel version = new JLabel(htmlLabel("RuneLite version: ", this.runeliteVersion));
      version.setFont(smallFont);
      JLabel revision = new JLabel();
      revision.setFont(smallFont);
      String engineVer = String.format("Rev %d", this.client.getRevision());
      revision.setText(htmlLabel("Oldschool revision: ", engineVer));
      JLabel launcher = new JLabel(htmlLabel("Launcher version: ", (String)MoreObjects.firstNonNull(RuneLiteProperties.getLauncherVersion(), "Unknown")));
      ...
      this.emailLabel.addHyperlinkListener((e) -> {
         if (EventType.ACTIVATED.equals(e.getEventType()) && e.getURL() != null && e.getURL().toString().equals("https://runelite_login/")) {
            ScheduledExecutorService var10000 = this.executor;
            SessionManager var10001 = this.sessionManager;
            Objects.requireNonNull(var10001);
            var10000.execute(var10001::login);
         }
      ...
      this.add(versionPanel, "North");
      this.add(this.actionsContainer, "Center");
      this.updateLoggedIn();
   ...
   private static JPanel buildLinkPanel(ImageIcon icon, String topText, String bottomText, final Runnable callback) {
      ...
      container.add(textContainer, "Center");
      JLabel arrowLabel = new JLabel(ARROW_RIGHT_ICON);
      container.add(arrowLabel, "East");
      return container;
   }

   private void updateLoggedIn() {
      String name = this.sessionManager.getAccountSession() != null ? this.sessionManager.getAccountSession().getUsername() : null;
      if (name != null) {
