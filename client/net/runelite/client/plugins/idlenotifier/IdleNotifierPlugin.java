...
public class IdleNotifierPlugin extends Plugin {
   ...
   public void onGameTick(GameTick event) {
      ...
      Duration waitDuration = Duration.ofMillis((long)this.config.getIdleNotificationDelay());
   ...
   private void migrateConfig() {
      ...
      if (!"1".equals(migrated)) {
         int hitpointsThreshold = (Integer)this.configManager.getConfiguration("idlenotifier", "hitpoints", (Type)Integer.TYPE);
         if (hitpointsThreshold == 0) {
            this.configManager.setConfiguration("idlenotifier", "hitpoints", (int)1);
            this.configManager.setConfiguration("idlenotifier", "hitpointsNotification", (Object)Notification.OFF);
         } else {
            this.configManager.setConfiguration("idlenotifier", "hitpointsNotification", (Object)Notification.ON);
         }

         int prayerThreshold = (Integer)this.configManager.getConfiguration("idlenotifier", "prayer", (Type)Integer.TYPE);
         if (prayerThreshold == 0) {
            this.configManager.setConfiguration("idlenotifier", "prayer", (int)1);
            this.configManager.setConfiguration("idlenotifier", "prayerNotification", (Object)Notification.OFF);
         } else {
            this.configManager.setConfiguration("idlenotifier", "prayerNotification", (Object)Notification.ON);
         }

         int lowEnergyThreshold = (Integer)this.configManager.getConfiguration("idlenotifier", "lowEnergy", (Type)Integer.TYPE);
         if (lowEnergyThreshold == 100) {
            this.configManager.setConfiguration("idlenotifier", "lowEnergy", (int)0);
            this.configManager.setConfiguration("idlenotifier", "lowEnergyNotification", (Object)Notification.OFF);
         } else {
            this.configManager.setConfiguration("idlenotifier", "lowEnergyNotification", (Object)Notification.ON);
         }

         int highEnergyThreshold = (Integer)this.configManager.getConfiguration("idlenotifier", "highEnergy", (Type)Integer.TYPE);
         if (highEnergyThreshold == 0) {
            this.configManager.setConfiguration("idlenotifier", "highEnergy", (int)100);
            this.configManager.setConfiguration("idlenotifier", "highEnergyNotification", (Object)Notification.OFF);
         } else {
            this.configManager.setConfiguration("idlenotifier", "highEnergyNotification", (Object)Notification.ON);
         }

         int oxygenThreshold = (Integer)this.configManager.getConfiguration("idlenotifier", "oxygen", (Type)Integer.TYPE);
         if (oxygenThreshold == 0) {
            this.configManager.setConfiguration("idlenotifier", "oxygen", (int)1);
            this.configManager.setConfiguration("idlenotifier", "oxygenNotification", (Object)Notification.OFF);
         } else {
            this.configManager.setConfiguration("idlenotifier", "oxygenNotification", (Object)Notification.ON);
         }

         int specThreshold = (Integer)this.configManager.getConfiguration("idlenotifier", "spec", (Type)Integer.TYPE);
         if (specThreshold == 0) {
            this.configManager.setConfiguration("idlenotifier", "spec", (int)1);
            this.configManager.setConfiguration("idlenotifier", "specNotification", (Object)Notification.OFF);
         } else {
            this.configManager.setConfiguration("idlenotifier", "specNotification", (Object)Notification.ON);
         }

         this.configManager.setConfiguration("idlenotifier", "migrated", (int)1);
      }
   }
   ...
   private void checkNpcInteraction(NPC target) {
      ...
      } else if (target.getName() != null && target.getName().contains("Fishing spot")) {
         this.resetTimers();
         this.lastInteract = target;
         this.lastInteracting = Instant.now();
   ...
   private boolean checkIdleLogout() {
      ...
      if (idleClientTicks < this.client.getIdleTimeout() - 1000) {
         ...
         return false;
      } else if (this.lastCombatCountdown <= 0) {
