...
class SlayerOverlay extends WidgetItemOverlay {
   ...
   private static final Set<Integer> ALL_SLAYER_ITEMS = (Set)((Stream)Stream.of(ItemVariationMapping.getVariations(11864).stream(), ItemVariationMapping.getVariations(11866).stream(), Stream.of(4155, 21270)).reduce(Stream::concat).orElseGet(Stream::empty)).collect(Collectors.toSet());
