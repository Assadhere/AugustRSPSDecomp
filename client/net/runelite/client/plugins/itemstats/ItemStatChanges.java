...
public class ItemStatChanges {
   ...
   public static final SingleEffect ATTACK_POT;
   public static final SingleEffect STRENGTH_POT;
   public static final SingleEffect DEFENCE_POT;
   public static final SingleEffect SUPER_ATTACK_POT;
   public static final SingleEffect SUPER_STRENGTH_POT;
   public static final SingleEffect SUPER_DEFENCE_POT;
   ...
   private void init() {
      ...
      this.add(Builders.food(8), 351, 9988, 2293, 2295, 2237, 2205, 2243, 2217, 7064, 20873, 6883, 20858, 31689);
      ...
      this.add(Builders.food(14), 6703, 7054, 373, 20877, 1959, 1961, 20862, 2343, 31695);
      this.add(Builders.food(15), 2231, 2187, 2229, 2185, 7568, 31556);
      this.add(Builders.food(16), 7946, 6705, 7056, 25960, 25958);
      this.add(Builders.food(17), 20864, 20879, 32312, 31564);
      this.add(Builders.food(18), 3144, 24595, 23533);
      this.add(Builders.food(19), 2011, 1883, 1885, 31703);
      this.add(Builders.food(20), 7058, 385, 20866, 20881, 7579, 20390, 23874, 31174, 32336);
      this.add(Builders.food(21), 397);
      this.add(Builders.food(22), 391, 24589, 11936, 7060);
      this.add(Builders.food(23), 20868, 20883);
      this.add(Builders.food(24), 32352);
      this.add(new Anglerfish(), 13441, 24592);
      this.add(Builders.food((maxHP) -> {
         return (int)Math.ceil((double)maxHP * 0.06);
      }), 5504);
      this.add(Builders.food((maxHP) -> {
         return (int)Math.ceil((double)maxHP * 0.05);
      }), 5984);
      ...
      this.add(new CappedStatBoost(Stats.HITPOINTS, (max) -> {
         return 18;
      }, (max) -> {
         return Math.min((int)((double)max * 0.2), 10);
      }), 32320);
      this.add(Builders.combo(Builders.food(19), Builders.heal(Stats.RUN_ENERGY, 20)), 32328);
      this.add(Builders.combo(Builders.food(22), Builders.heal(Stats.PRAYER, 5)), 32344);
      ...
      this.add(Builders.combo(Builders.boost(Stats.SAILING, 1), Builders.boost(Stats.MAGIC, 2), Builders.dec(Stats.ATTACK, 2)), 31814);
      this.add(Builders.combo(Builders.boost(Stats.SAILING, 1), Builders.boost(Stats.RANGED, 2), Builders.boost(Stats.STRENGTH, 2), Builders.dec(Stats.MAGIC, 2)), 31817);
      this.add(Builders.combo(Builders.boost(Stats.SAILING, 2), Builders.boost(Stats.FISHING, 2), Builders.dec(Stats.ATTACK, 2)), 31820);
      this.add(Builders.combo(Builders.boost(Stats.SAILING, 3), Builders.boost(Stats.COOKING, 2), Builders.dec(Stats.AGILITY, 2)), 31811);
      this.add(Builders.combo(Builders.boost(Stats.SAILING, 4), Builders.dec(Stats.THIEVING, 2)), 31823);
      this.add(Builders.combo(Builders.boost(Stats.SLAYER, 1), new BoostedStatBoost(Stats.SAILING, false, Builders.perc(0.02, -2)), new BoostedStatBoost(Stats.ATTACK, false, Builders.perc(0.02, -2)), new BoostedStatBoost(Stats.STRENGTH, false, Builders.perc(0.02, -2)), new BoostedStatBoost(Stats.DEFENCE, false, Builders.perc(0.02, -2))), 31258);
      this.add(Builders.combo(Builders.boost(Stats.FISHING, 1), new BoostedStatBoost(Stats.SAILING, false, Builders.perc(0.02, -2)), new BoostedStatBoost(Stats.ATTACK, false, Builders.perc(0.02, -2)), new BoostedStatBoost(Stats.STRENGTH, false, Builders.perc(0.02, -2)), new BoostedStatBoost(Stats.DEFENCE, false, Builders.perc(0.02, -2))), 31255);
      this.add(Builders.combo(Builders.boost(Stats.HUNTER, 1), new BoostedStatBoost(Stats.SAILING, false, Builders.perc(0.02, -2)), new BoostedStatBoost(Stats.ATTACK, false, Builders.perc(0.02, -2)), new BoostedStatBoost(Stats.STRENGTH, false, Builders.perc(0.02, -2)), new BoostedStatBoost(Stats.DEFENCE, false, Builders.perc(0.02, -2))), 31261);
      ...
      Effect magicEssence = Builders.boost(Stats.MAGIC, 3);
      SingleEffect magicPot = Builders.boost(Stats.MAGIC, 4);
      SingleEffect imbuedHeart = Builders.boost(Stats.MAGIC, Builders.perc(0.1, 1));
      SingleEffect rangingPot = Builders.boost(Stats.RANGED, Builders.perc(0.1, 4));
      SingleEffect superMagicPot = Builders.boost(Stats.MAGIC, Builders.perc(0.15, 5));
      SingleEffect superRangingPot = Builders.boost(Stats.RANGED, Builders.perc(0.15, 5));
      SingleEffect divinePot = Builders.heal(Stats.HITPOINTS, -10);
      ...
      Effect ancientBrew = new AncientBrew(0.05, 2);
      ...
      this.add(Builders.combo(Builders.boost(Stats.HITPOINTS, Builders.perc(0.1, 2)), Builders.boost(Stats.RANGED, Builders.perc(0.1, 4)), new BoostedStatBoost(Stats.ATTACK, false, Builders.perc(0.1, -2)), new BoostedStatBoost(Stats.STRENGTH, false, Builders.perc(0.1, -2)), new BoostedStatBoost(Stats.DEFENCE, false, Builders.perc(0.1, -2)), new BoostedStatBoost(Stats.MAGIC, false, Builders.perc(0.1, -2))), 31659, 31656, 31653, 31650);
      ...
      this.add(Builders.combo(Builders.boost(Stats.ATTACK, Builders.perc(0.15, 8)), Builders.boost(Stats.STRENGTH, Builders.perc(0.15, 8)), new BoostedStatBoost(Stats.DEFENCE, false, Builders.perc(0.1, -1)), Builders.boost(Stats.RANGED, Builders.perc(0.1, 7)), Builders.boost(Stats.MAGIC, Builders.perc(0.1, 1)), Builders.heal(Stats.HITPOINTS, -10)), 29640, 29637, 29634, 29631);
      ...
      Effect energyPot = Builders.heal(Stats.RUN_ENERGY, 10);
      SingleEffect prayerPot = new PrayerPotion(7);
      Effect superEnergyPot = Builders.heal(Stats.RUN_ENERGY, 20);
      Effect superRestorePot = new SuperRestore(0.25, 8);
      SingleEffect staminaPot = new StaminaPotion(20);
      ...
      this.add(new StaminaPotion(40), 31647, 31644, 31641, 31638);
      this.add(Builders.heal(Stats.RUN_ENERGY, 40), 31623, 31620, 31617, 31614);
      ...
      Effect agilityPot = Builders.boost(Stats.AGILITY, 3);
      Effect fishingPot = Builders.boost(Stats.FISHING, 3);
      Effect hunterPot = Builders.boost(Stats.HUNTER, 3);
      this.add(agilityPot, 3038, 3036, 3034, 3032);
      this.add(fishingPot, 155, 153, 151, 2438);
      this.add(Builders.boost(Stats.FISHING, 6), 31611, 31608, 31605, 31602);
      this.add(hunterPot, 10004, 10002, 10000, 9998);
      this.add(Builders.boost(Stats.HUNTER, 6), 31635, 31632, 31629, 31626);
      ...
      this.add(new DwarvenRockCake(), 7510);
      this.add(new LocatorOrb(), 22081);
      ...
      log.debug("{} items; {} behaviours loaded", this.effects.size(), (new HashSet(this.effects.values())).size());
   }
   ...
   private void add(Effect effect, int... items) {
      ...
      for(int var5 = 0; var5 < var4; ++var5) {
         int item = var3[var5];
         Effect prev = (Effect)this.effects.put(item, effect);
   ...
   public Effect get(int id) {
      return (Effect)this.effects.get(id);
   }

   static {
      ATTACK_POT = Builders.boost(Stats.ATTACK, Builders.perc(0.1, 3));
      STRENGTH_POT = Builders.boost(Stats.STRENGTH, Builders.perc(0.1, 3));
      DEFENCE_POT = Builders.boost(Stats.DEFENCE, Builders.perc(0.1, 3));
      SUPER_ATTACK_POT = Builders.boost(Stats.ATTACK, Builders.perc(0.15, 5));
      SUPER_STRENGTH_POT = Builders.boost(Stats.STRENGTH, Builders.perc(0.15, 5));
      SUPER_DEFENCE_POT = Builders.boost(Stats.DEFENCE, Builders.perc(0.15, 5));
   }
}
