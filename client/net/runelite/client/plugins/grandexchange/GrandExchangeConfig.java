...
public interface GrandExchangeConfig extends Config {
   ...
   @ConfigItem(
      ...
      name = "Search mode",
      description = "The search mode to use for the GE:<br>Default - Matches exact text only<br>Fuzzy Only - Matches inexact text such as 'sara sword'<br>Fuzzy Fallback - Uses default search, falling back to fuzzy search if no results were found"
   )
