...
class ScreenMarkerPanel extends JPanel {
   ...
   private static final Border NAME_BOTTOM_BORDER;
   ...
   ScreenMarkerPanel(final ScreenMarkerPlugin plugin, final ScreenMarkerOverlay marker) {
      this.thicknessSpinner = new JSpinner(this.spinnerModel);
      this.plugin = plugin;
      this.marker = marker;
      ...
      this.nameInput.setBorder((Border)null);
      ...
      nameWrapper.add(this.nameInput, "Center");
      ...
      this.thicknessSpinner.addChangeListener((ce) -> {
         this.updateThickness(true);
      });
      ...
      this.labelIndicator.addMouseListener(new MouseAdapter() {
         ...
         public void mouseEntered(MouseEvent mouseEvent) {
            ScreenMarkerPanel.this.labelIndicator.setIcon(ScreenMarkerPanel.this.showLabel ? ScreenMarkerPanel.LABEL_HOVER_ICON : ScreenMarkerPanel.NO_LABEL_HOVER_ICON);
         }

         public void mouseExited(MouseEvent mouseEvent) {
            ScreenMarkerPanel.this.labelIndicator.setIcon(ScreenMarkerPanel.this.showLabel ? ScreenMarkerPanel.LABEL_ICON : ScreenMarkerPanel.NO_LABEL_ICON);
         }
      });
   ...
   private void openFillColorPicker() {
      ...
      RuneliteColorPicker colorPicker = this.plugin.getColorPickerManager().create((Component)this, fillColor.getAlpha() == 0 ? ColorUtil.colorWithAlpha(fillColor, 75) : fillColor, this.marker.getMarker().getName() + " Fill", false);
   ...
   private void openBorderColorPicker() {
      RuneliteColorPicker colorPicker = this.plugin.getColorPickerManager().create((Component)this, this.marker.getMarker().getColor(), this.marker.getMarker().getName() + " Border", false);
      colorPicker.setLocationRelativeTo(this);
      colorPicker.setOnColorChange((c) -> {
   ...
   static {
      NAME_BOTTOM_BORDER = new CompoundBorder(BorderFactory.createMatteBorder(0, 0, 1, 0, ColorScheme.DARK_GRAY_COLOR), BorderFactory.createLineBorder(ColorScheme.DARKER_GRAY_COLOR));
