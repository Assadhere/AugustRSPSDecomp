   ...
   public Dimension render(Graphics2D graphics) {
      if (!this.showMap) {
         ...
         if (image == null) {
            ...
            image = minimapToBufferedImage(map, this.client.isResized() ? this.client.getExpandedMapLoading() : 0);
            synchronized(this) {
               if (this.showMap) {
                  this.mapImage = image;
               }
         ...
         if (closeButton != null) {
            graphics.drawImage(closeButton, (int)this.closeButtonBounds.getX(), (int)this.closeButtonBounds.getY(), (ImageObserver)null);
         }
