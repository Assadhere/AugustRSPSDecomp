...
public class AlchemyRoom extends MTARoom {
         ...
         if (this.best == null || this.best != bestItem) {
            if (this.best != null) {
               this.infoBoxManager.removeIf((e) -> {
                  return e instanceof AlchemyRoomTimer;
               });
      ...
      if (this.inside() && this.config.alchemy()) {
         ...
         if (wrapper.getType() == ChatMessageType.GAMEMESSAGE) {
            if (message.contains("You found:")) {
               String item = message.replace("You found:", "").trim();
            ...
            } else if (message.equals("The cupboard is empty.")) {
               Cupboard clicked = this.getClicked();
   ...
   private Cupboard getClicked() {
      ...
      Cupboard[] var5 = this.cupboards;
      int var6 = var5.length;

      for(int var7 = 0; var7 < var6; ++var7) {
         Cupboard cupboard = var5[var7];
         if (cupboard != null) {
            double objectDistance = (double)cupboard.gameObject.getWorldLocation().distanceTo(mine);
   ...
   public void under(Graphics2D graphics) {
      if (this.getConfig().alchemy() && this.best != null && this.inside()) {
         boolean found = false;
         Cupboard[] var3 = this.cupboards;
         int var4 = var3.length;

         for(int var5 = 0; var5 < var4; ++var5) {
            Cupboard cupboard = var3[var5];
            if (cupboard != null) {
               ...
               if (alchemyItem != AlchemyItem.EMPTY) {
                  ...
                  BufferedImage image = this.itemManager.getImage(alchemyItem.getId());
                  Point canvasLoc = Perspective.getCanvasImageLocation(this.client, object.getLocalLocation(), image, 150);
                  if (canvasLoc != null) {
                     graphics.drawImage(image, canvasLoc.getX(), canvasLoc.getY(), (ImageObserver)null);
                  }
               }
            }
         }
   ...
   private Cupboard getSuggestion() {
      if (this.best != null) {
         Cupboard[] var1 = this.cupboards;
         int var2 = var1.length;

         for(int var3 = 0; var3 < var2; ++var3) {
            Cupboard cupboard = var1[var3];
