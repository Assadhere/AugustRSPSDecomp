...
class NotesPanel extends PluginPanel {
   ...
   void init(final NotesConfig config) {
      ...
      this.notesEditor.getDocument().addUndoableEditListener((e) -> {
         this.undoRedo.addEdit(e.getEdit());
      });
      ...
      this.notesEditor.getActionMap().put("Undo", new AbstractAction("Undo") {
         public void actionPerformed(ActionEvent e) {
            try {
               ...
               CannotUndoException ex = var3;
               NotesPanel.log.warn("Notes Document Unable To Undo: " + String.valueOf(ex));
            }
      ...
      this.notesEditor.getActionMap().put("Redo", new AbstractAction("Redo") {
         public void actionPerformed(ActionEvent e) {
            try {
               ...
               CannotUndoException ex = var3;
               NotesPanel.log.warn("Notes Document Unable To Redo: " + String.valueOf(ex));
            }
      ...
      this.notesEditor.addFocusListener(new FocusListener() {
         ...
         private void notesChanged(Document doc) {
            try {
               ...
               BadLocationException ex = var3;
               NotesPanel.log.warn("Notes Document Bad Location: " + String.valueOf(ex));
            }

         }
      });
      notesContainer.add(this.notesEditor, "Center");
