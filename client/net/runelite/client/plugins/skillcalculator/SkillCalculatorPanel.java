...
class SkillCalculatorPanel extends PluginPanel {
   ...
   private void addCalculatorButtons() {
      CalculatorType[] var1 = CalculatorType.values();
      int var2 = var1.length;

      for(int var3 = 0; var3 < var2; ++var3) {
         CalculatorType calculatorType = var1[var3];
         ImageIcon icon = new ImageIcon(this.iconManager.getSkillImage(calculatorType.getSkill(), true));
         MaterialTab tab = new MaterialTab(icon, this.tabGroup, (JComponent)null);
