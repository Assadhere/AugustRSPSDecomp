...
public interface ScreenshotConfig extends Config {
   ...
   @ConfigItem(
      ...
      description = "Configures whether screenshots are automatically taken when you receive a valuable drop.<br>Requires 'Loot drop notifications' to be enabled in the RuneScape settings.",
      position = 14,
      section = "what"
   )
   ...
   @ConfigItem(
      ...
      description = "The minimum value to save screenshots of valuable drops.<br>Requires 'Minimum item value needed for loot notification' to be set to a lesser or equal value in the RuneScape settings.",
      position = 15,
      section = "what"
   )
   ...
   @ConfigItem(
      ...
      description = "Configures whether screenshots are automatically taken when you receive an untradeable drop.<br>Requires 'Untradeable loot notifications' to be enabled in the RuneScape settings.",
      position = 16,
      section = "what"
   )
   ...
   @ConfigItem(
      ...
      description = "Take a screenshot when completing an entry in the collection log.<br>Requires 'Collection log - New addition notification' to be enabled in the RuneScape settings.",
      position = 19,
      section = "what"
   )
