...
enum HealthbarOverride implements net.runelite.client.game.SpriteOverride {
   ...
   static HealthbarOverride get(int spriteID) {
      return (HealthbarOverride)MAP.get(spriteID);
   }

   public String getFileName() {
      String var10000 = Skin.AROUND_2010.toString();
      return var10000 + "/healthbar/" + this.fileName;
   }
   ...
   static {
      ...
      HealthbarOverride[] var1 = values();
      int var2 = var1.length;

      for(int var3 = 0; var3 < var2; ++var3) {
         HealthbarOverride override = var1[var3];
