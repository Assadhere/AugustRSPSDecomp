...
public class CipherClue extends ClueScroll implements NpcClueScroll, LocationClueScroll {
   ...
   private CipherClue(@Nullable Integer itemId, String text, Integer npc, @Nullable WorldPoint location, @Nullable Function<ClueScrollPlugin, WorldPoint> locationProvider, @Nullable String area, @Nullable Function<ClueScrollPlugin, String> areaProvider, @Nullable String question, @Nullable String answer) {
      ...
      this.locationProvider = locationProvider != null ? locationProvider : (plugin) -> {
         return location;
      };
      this.areaProvider = areaProvider != null ? areaProvider : (plugin) -> {
         return area;
      };
   ...
   public WorldPoint getLocation(ClueScrollPlugin plugin) {
      return (WorldPoint)this.locationProvider.apply(plugin);
   }

   @VisibleForTesting
   String getArea(ClueScrollPlugin plugin) {
      return (String)this.areaProvider.apply(plugin);
   }
   ...
   public static CipherClue forText(String text) {
      ...
      do {
         ...
         clue = (CipherClue)var1.next();
      } while(!text.equalsIgnoreCase(clue.text) && !text.equalsIgnoreCase(clue.question));
   ...
   public static class CipherClueBuilder {
      ...
      public String toString() {
         ...
         return "CipherClue.CipherClueBuilder(itemId=" + var10000 + ", text=" + this.text + ", npc=" + this.npc + ", location=" + String.valueOf(this.location) + ", locationProvider=" + String.valueOf(this.locationProvider) + ", area=" + this.area + ", areaProvider=" + String.valueOf(this.areaProvider) + ", question=" + this.question + ", answer=" + this.answer + ")";
      }
   }
}
