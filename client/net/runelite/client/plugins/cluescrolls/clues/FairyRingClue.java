...
public class FairyRingClue extends ClueScroll implements LocationClueScroll {
   static final List<FairyRingClue> CLUES = ImmutableList.of(new FairyRingClue(19864, "A I R 2 3 3 1", new WorldPoint(2702, 3246, 0)), new FairyRingClue(19862, "A I Q 0 4 4 0", new WorldPoint(3000, 3110, 0)), new FairyRingClue(28915, "A J P 3 0 1 5", new WorldPoint(1646, 3012, 0)), new FairyRingClue(19866, "A L P 1 1 4 0", new WorldPoint(2504, 3633, 0)), new FairyRingClue(19872, "B L P 6 2 0 0", new WorldPoint(2439, 5132, 0)), new FairyRingClue(19870, "B J R 1 1 2 3", new WorldPoint(2648, 4729, 0)), new FairyRingClue(19868, "B I P 7 0 1 3", new WorldPoint(3407, 3330, 0)), new FairyRingClue(19880, "C I S 0 0 0 9", new WorldPoint(1630, 3868, 0)), new FairyRingClue(19874, "C K P 0 2 2 4", new WorldPoint(2073, 4846, 0)), new FairyRingClue(19876, "D I P 8 5 1 1", new WorldPoint(3041, 4770, 0)), new FairyRingClue(19878, "D K S 2 3 1 0", new WorldPoint(2747, 3720, 0)));
   ...
   public void makeWorldOverlayHint(Graphics2D graphics, ClueScrollPlugin plugin) {
      LocalPoint localLocation = LocalPoint.fromWorld(plugin.getClient(), this.getLocation(plugin));
