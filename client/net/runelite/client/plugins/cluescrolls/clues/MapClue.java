...
public class MapClue extends ClueScroll implements ObjectClueScroll {
   ...
   private MapClue(int itemId, WorldPoint location, int objectId) {
      this(itemId, location, objectId, (String)null);
   }
      ...
      if (localLocation != null) {
         if (this.objectId != -1) {
            ...
            if (plugin.getObjectsToMark() != null) {
               Iterator var5 = plugin.getObjectsToMark().iterator();

               while(var5.hasNext()) {
                  TileObject gameObject = (TileObject)var5.next();
