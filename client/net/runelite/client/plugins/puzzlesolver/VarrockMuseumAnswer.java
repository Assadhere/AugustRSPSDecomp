...
enum VarrockMuseumAnswer {
   ...
   static Widget findCorrect(Client client, String question, int... widgets) {
      String s = (String)MATCHES.get(question);
      int[] var4 = widgets;
      int var5 = widgets.length;

      for(int var6 = 0; var6 < var5; ++var6) {
         int widgetInfo = var4[var6];
   ...
   static {
      ...
      VarrockMuseumAnswer[] var1 = values();
      int var2 = var1.length;

      for(int var3 = 0; var3 < var2; ++var3) {
         VarrockMuseumAnswer varrockMuseumAnswer = var1[var3];
