...
enum ItemWithCharge {
   ...
   BLIGHTED_OVERLOAD1(ItemChargeType.POTION, 29640, 1),
   BLIGHTED_OVERLOAD2(ItemChargeType.POTION, 29637, 2),
   BLIGHTED_OVERLOAD3(ItemChargeType.POTION, 29634, 3),
   BLIGHTED_OVERLOAD4(ItemChargeType.POTION, 29631, 4),
   ...
   ARMA_BREW1(ItemChargeType.POTION, 31659, 1),
   ARMA_BREW2(ItemChargeType.POTION, 31656, 2),
   ARMA_BREW3(ItemChargeType.POTION, 31653, 3),
   ARMA_BREW4(ItemChargeType.POTION, 31650, 4),
   EXTENDED_STAM1(ItemChargeType.POTION, 31647, 1),
   EXTENDED_STAM2(ItemChargeType.POTION, 31644, 2),
   EXTENDED_STAM3(ItemChargeType.POTION, 31641, 3),
   EXTENDED_STAM4(ItemChargeType.POTION, 31638, 4),
   EXTREME_ENERGY1(ItemChargeType.POTION, 31623, 1),
   EXTREME_ENERGY2(ItemChargeType.POTION, 31620, 2),
   EXTREME_ENERGY3(ItemChargeType.POTION, 31617, 3),
   EXTREME_ENERGY4(ItemChargeType.POTION, 31614, 4),
   HAEMOSTATIC_DRESS1(ItemChargeType.POTION, 31599, 1),
   HAEMOSTATIC_DRESS2(ItemChargeType.POTION, 31596, 2),
   HAEMOSTATIC_DRESS3(ItemChargeType.POTION, 31593, 3),
   HAEMOSTATIC_DRESS4(ItemChargeType.POTION, 31590, 4),
   SUPER_FISHING1(ItemChargeType.POTION, 31611, 1),
   SUPER_FISHING2(ItemChargeType.POTION, 31608, 2),
   SUPER_FISHING3(ItemChargeType.POTION, 31605, 3),
   SUPER_FISHING4(ItemChargeType.POTION, 31602, 4),
   SUPER_HUNTER1(ItemChargeType.POTION, 31635, 1),
   SUPER_HUNTER2(ItemChargeType.POTION, 31632, 2),
   SUPER_HUNTER3(ItemChargeType.POTION, 31629, 3),
   SUPER_HUNTER4(ItemChargeType.POTION, 31626, 4);
   ...
   static ItemWithCharge findItem(int itemId) {
      return (ItemWithCharge)ID_MAP.get(itemId);
   }
   ...
   static {
      ...
      ItemWithCharge[] var1 = values();
      int var2 = var1.length;

      for(int var3 = 0; var3 < var2; ++var3) {
         ItemWithCharge itemCharge = var1[var3];
