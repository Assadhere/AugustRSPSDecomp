...
class Obstacles {
   ...
   static {
      ...
      AgilityShortcut[] var1 = AgilityShortcut.values();
      int var2 = var1.length;

      for(int var3 = 0; var3 < var2; ++var3) {
         AgilityShortcut item = var1[var3];
         int[] var5 = item.getObstacleIds();
         int var6 = var5.length;

         for(int var7 = 0; var7 < var6; ++var7) {
            int obstacle = var5[var7];
            builder.put(obstacle, item);
         }
      }

      SHORTCUT_OBSTACLE_IDS = builder.build();
      SEPULCHRE_OBSTACLE_IDS = ImmutableSet.of(38460, 38455, 38456, 38457, 38458, 38459, new Integer[]{38470, 38477, 38462, 38463, 38464, 38465, 38466, 38467, 38468, 38469, 38471, 38472, 38473, 38474, 38475, 38476});
      SEPULCHRE_SKILL_OBSTACLE_IDS = ImmutableSet.of(39524, 39525, 39526, 39527, 39528, 39533, new Integer[0]);
   }
}
