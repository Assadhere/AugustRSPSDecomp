...
public class DpsCounterPlugin extends Plugin {
   ...
   public void onHitsplatApplied(HitsplatApplied hitsplatApplied) {
      ...
      if (actor instanceof NPC) {
         ...
         if (hitsplat.isMine()) {
            ...
            DpsMember dpsMember = (DpsMember)this.members.computeIfAbsent(name, DpsMember::new);
   ...
   void pause() {
      if (!this.total.isPaused()) {
         log.debug("Pausing");
         Iterator var1 = this.members.values().iterator();

         while(var1.hasNext()) {
            DpsMember dpsMember = (DpsMember)var1.next();
            dpsMember.pause();
         }
