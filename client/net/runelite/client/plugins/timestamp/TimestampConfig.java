...
public interface TimestampConfig extends Config {
   ...
   @ConfigItem(
      ...
      position = 3,
      description = "Customize your timestamp format by using the following characters:<br>'yyyy' : year<br>'MM' : month<br>'dd' : day<br>'HH' : hour in 24 hour format<br>'hh' : hour in 12 hour format<br>'mm' : minute<br>'ss' : second<br>'a'  : AM/PM"
   )
