...
public class Regions {
   ...
   public int getRegionId(int cx, int cy) {
      ...
      if (!this.isMarked(rx, ry)) {
         return 0;
      } else if (this.last != null && intersects(cx, cy, this.last)) {
         return this.last.id;
      } else {
   ...
   private void markRegion(int rx, int ry) {
      ...
      if (idx < this.regionMap.length) {
         byte[] var10000 = this.regionMap;
         var10000[idx] = (byte)(var10000[idx] | 1 << idx % 8);
      }
