...
public class TimeTrackingPlugin extends Plugin {
   ...
   protected void shutDown() throws Exception {
      ...
      this.eventBus.unregister((Object)this.paymentTracker);
      this.eventBus.unregister((Object)this.compostTracker);
      ...
      this.farmingContractManager.setInfoBox((FarmingContractInfoBox)null);
   }
   ...
   public void onGameTick(GameTick t) {
      if (this.client.getGameState() != GameState.LOGGED_IN) {
         ...
         } else if (this.lastTickPostLogin) {
            this.lastTickPostLogin = false;
         } else {
   ...
   public void onChatMessage(ChatMessage event) {
      if (event.getType() == ChatMessageType.GAMEMESSAGE && event.getMessage().equals("You've completed a Farming Guild Contract. You should return to Guildmaster Jane.")) {
         this.farmingContractManager.setContract((Produce)null);
      }
   }
