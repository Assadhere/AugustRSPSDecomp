...
class FarmingPatch {
   ...
   String configKey() {
      int var10000 = this.region.getRegionID();
      return "" + var10000 + "." + this.varbit;
   }

   String notifyConfigKey() {
      int var10000 = this.region.getRegionID();
      return "notify." + var10000 + "." + this.varbit;
   }
   ...
   public String toString() {
      String var10000 = String.valueOf(this.getRegion());
      return "FarmingPatch(region=" + var10000 + ", name=" + this.getName() + ", implementation=" + String.valueOf(this.getImplementation()) + ")";
   }
