...
public enum Produce {
   ...
   FLAX("Flax", PatchImplementation.HOPS, 1779, 20, 4, 0, 3),
   KRANDORIAN("Krandorian", PatchImplementation.HOPS, 6000, 10, 8, 0, 3),
   WILDBLOOD("Wildblood", PatchImplementation.HOPS, 6002, 10, 9, 0, 3),
   HEMP("Hemp", PatchImplementation.HOPS, 31457, 20, 5, 0, 3),
   COTTON("Cotton", PatchImplementation.HOPS, 31460, 20, 6, 0, 3),
   ...
   CAMPHOR("Camphor", PatchImplementation.HARDWOOD_TREE, 32904, 640, 9),
   IRONWOOD("Ironwood", PatchImplementation.HARDWOOD_TREE, 32907, 640, 9),
   ROSEWOOD("Rosewood", PatchImplementation.HARDWOOD_TREE, 32910, 640, 10),
   ...
   ELKHORN_CORAL("Elkhorn", PatchImplementation.CORAL, 31481, 40, 5),
   PILLAR_CORAL("Pillar", PatchImplementation.CORAL, 31484, 40, 5),
   UMBRAL_CORAL("Umbral", PatchImplementation.CORAL, 31487, 40, 5),
   ...
   private Produce(String name, int itemID, int tickrate, int stages, int regrowTickrate, int harvestStages) {
      this(name, name, (PatchImplementation)null, itemID, tickrate, stages, regrowTickrate, harvestStages);
   }
   ...
   private Produce(String name, int itemID, int tickrate, int stages) {
      this(name, name, (PatchImplementation)null, itemID, tickrate, stages, 0, 1);
   }
