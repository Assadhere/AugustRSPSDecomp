...
public class NpcUtil {
   ...
   void onNpcChanged(NpcChanged e) {
      ...
      switch (id) {
         ...
         default:
            if (this.runtimeConfig != null) {
               Set<Integer> resetDeadOnChangeNpcs = this.runtimeConfig.getResetDeadOnChangeNpcs();
   ...
   public void onAnimationChanged(AnimationChanged animationChanged) {
      ...
      switch (anim) {
         case 1676:
            if (!(actor instanceof NPC) || ((NPC)actor).getId() != 319) {
               break;
            }
         case 7992:
         case 8000:
         ...
         default:
            if (this.runtimeConfig != null) {
               Set<Integer> forceDeadAnimations = this.runtimeConfig.getForceDeadAnimations();
