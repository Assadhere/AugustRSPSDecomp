...
public final class ItemEquipmentStats {
   ...
   public boolean equals(Object o) {
      if (o == this) {
         return true;
      } else if (!(o instanceof ItemEquipmentStats)) {
         return false;
      } else {
         ItemEquipmentStats other = (ItemEquipmentStats)o;
         if (this.getSlot() != other.getSlot()) {
            return false;
         } else if (this.isTwoHanded() != other.isTwoHanded()) {
            return false;
         } else if (this.getAstab() != other.getAstab()) {
            return false;
         } else if (this.getAslash() != other.getAslash()) {
            return false;
         } else if (this.getAcrush() != other.getAcrush()) {
            return false;
         } else if (this.getAmagic() != other.getAmagic()) {
            return false;
         } else if (this.getArange() != other.getArange()) {
            return false;
         } else if (this.getDstab() != other.getDstab()) {
            return false;
         } else if (this.getDslash() != other.getDslash()) {
            return false;
         } else if (this.getDcrush() != other.getDcrush()) {
            return false;
         } else if (this.getDmagic() != other.getDmagic()) {
            return false;
         } else if (this.getDrange() != other.getDrange()) {
            return false;
         } else if (this.getStr() != other.getStr()) {
            return false;
         } else if (this.getRstr() != other.getRstr()) {
            return false;
         } else if (Float.compare(this.getMdmg(), other.getMdmg()) != 0) {
            return false;
         } else if (this.getPrayer() != other.getPrayer()) {
            return false;
         } else {
   ...
   public String toString() {
      ...
      return "ItemEquipmentStats(slot=" + var10000 + ", isTwoHanded=" + this.isTwoHanded() + ", astab=" + this.getAstab() + ", aslash=" + this.getAslash() + ", acrush=" + this.getAcrush() + ", amagic=" + this.getAmagic() + ", arange=" + this.getArange() + ", dstab=" + this.getDstab() + ", dslash=" + this.getDslash() + ", dcrush=" + this.getDcrush() + ", dmagic=" + this.getDmagic() + ", drange=" + this.getDrange() + ", str=" + this.getStr() + ", rstr=" + this.getRstr() + ", mdmg=" + this.getMdmg() + ", prayer=" + this.getPrayer() + ", aspeed=" + this.getAspeed() + ")";
   }
