...
public final class DiscordReady {
   ...
   public boolean equals(Object o) {
      if (o == this) {
         return true;
      } else if (!(o instanceof DiscordReady)) {
         return false;
      } else {
         DiscordReady other;
         label56: {
            other = (DiscordReady)o;
   ...
   public String toString() {
      ...
      return "DiscordReady(userId=" + var10000 + ", username=" + this.getUsername() + ", discriminator=" + this.getDiscriminator() + ", avatar=" + this.getAvatar() + ")";
   }
}
