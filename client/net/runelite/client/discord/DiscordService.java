...
public class DiscordService implements AutoCloseable {
   ...
   @Inject
   private DiscordService(EventBus eventBus, ScheduledExecutorService executorService, @Named("runelite.discord.enable") boolean enable, @Named("runelite.discord.appid") String discordAppId) {
   ...
   public void init() {
      if (this.discordRPC != null) {
         ...
         this.discordRPC.Discord_Initialize(this.discordAppId, this.discordEventHandlers, true, (String)null);
         ScheduledExecutorService var10000 = this.executorService;
         DiscordRPC var10001 = this.discordRPC;
         Objects.requireNonNull(var10001);
         var10000.scheduleAtFixedRate(var10001::Discord_RunCallbacks, 0L, 2L, TimeUnit.SECONDS);
      }
   }
