...
public class ChatCommandManager {
   ...
   public void registerCommand(String command, BiConsumer<ChatMessage, String> execute) {
      this.registerCommand(command, execute, (BiPredicate)null);
   }
   ...
   public void registerCommandAsync(String command, BiConsumer<ChatMessage, String> execute) {
      this.registerCommandAsync(command, execute, (BiPredicate)null);
   }
   ...
   public void onChatMessage(ChatMessage chatMessage) {
      switch (chatMessage.getType()) {
         ...
         case CLAN_GIM_CHAT:
            ...
            ChatCommand chatCommand = (ChatCommand)this.commands.get(command.toLowerCase());
            if (chatCommand == null) {
               return;
            }
