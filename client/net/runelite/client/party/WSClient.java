...
public class WSClient extends WebSocketListener implements AutoCloseable {
   ...
   void send(WebsocketMessage message) {
      ...
      String json = this.gson.toJson(message, WebsocketMessage.class);
      Party.Data data = (Party.Data)Party.Data.newBuilder().setType(message.getClass().getSimpleName()).setData(ByteString.copyFromUtf8(json)).build();
   ...
   public void onMessage(WebSocket webSocket, okio.ByteString bytes) {
      ...
      try {
         ...
         InvalidProtocolBufferException e = var12;
