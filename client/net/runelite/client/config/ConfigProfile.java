...
public class ConfigProfile {
   ...
   public String toString() {
      ...
      return "ConfigProfile(id=" + var10000 + ", name=" + this.getName() + ", sync=" + this.isSync() + ", active=" + this.isActive() + ", rev=" + this.getRev() + ", defaultForRsProfiles=" + String.valueOf(this.getDefaultForRsProfiles()) + ")";
   }
