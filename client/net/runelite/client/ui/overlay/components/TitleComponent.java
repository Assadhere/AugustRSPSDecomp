...
public class TitleComponent implements LayoutableRenderableEntity {
   ...
   public Dimension render(Graphics2D graphics) {
      ...
      titleComponent.setPosition(baseX + (this.preferredSize.width - metrics.stringWidth(this.text)) / 2, baseY + metrics.getHeight());
   ...
   public static class TitleComponentBuilder {
      ...
      public String toString() {
         ...
         return "TitleComponent.TitleComponentBuilder(text=" + var10000 + ", color$value=" + String.valueOf(this.color$value) + ", preferredLocation$value=" + String.valueOf(this.preferredLocation$value) + ", preferredSize$value=" + String.valueOf(this.preferredSize$value) + ", bounds$value=" + String.valueOf(this.bounds$value) + ")";
      }
   }
}
