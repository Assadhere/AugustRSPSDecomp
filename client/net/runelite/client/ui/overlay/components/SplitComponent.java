...
public class SplitComponent implements LayoutableRenderableEntity {
   ...
   public static class SplitComponentBuilder {
      ...
      public String toString() {
         ...
         return "SplitComponent.SplitComponentBuilder(first=" + var10000 + ", second=" + String.valueOf(this.second) + ", preferredLocation$value=" + String.valueOf(this.preferredLocation$value) + ", preferredSize$value=" + String.valueOf(this.preferredSize$value) + ", orientation$value=" + String.valueOf(this.orientation$value) + ", gap$value=" + String.valueOf(this.gap$value) + ", bounds$value=" + String.valueOf(this.bounds$value) + ")";
      }
   }
}
