...
public class WidgetOverlay extends Overlay {
   ...
   private Rectangle getParentBounds(Widget widget) {
      if (widget != null && !widget.isHidden()) {
         ...
         Rectangle bounds;
         if (parent == null) {
            bounds = new Rectangle(this.client.getRealDimensions());
         } else {
         ...
         this.parentBounds.setBounds(0, 0, 0, 0);
   ...
   private static class PvpKDRWidgetOverlay extends WidgetOverlay {
      ...
      public Dimension render(Graphics2D graphics) {
         return this.client.getVarbitValue(4143) == 1 ? super.render(graphics) : null;
      }
   }
   ...
   private static class XpTrackerWidgetOverlay extends WidgetOverlay {
      ...
      public Dimension render(Graphics2D graphics) {
         return this.client.getVarbitValue(4697) == 30 && this.client.getVarbitValue(4698) == 0 ? null : super.render(graphics);
      }
