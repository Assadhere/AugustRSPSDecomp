...
public class ColorPanel extends JPanel {
   ...
   private Point closestPointToColor(Color target) {
      float[] hsb = Color.RGBtoHSB(target.getRed(), target.getGreen(), target.getBlue(), (float[])null);
   ...
   private void redrawGradient() {
      ...
      GradientPaint primary = new GradientPaint(0.0F, 0.0F, Color.WHITE, (float)(this.size - 1), 0.0F, primaryRight);
      GradientPaint shade = new GradientPaint(0.0F, 0.0F, new Color(0, 0, 0, 0), 0.0F, (float)(this.size - 1), Color.BLACK);
      g.setPaint(primary);
